...
import com.bisket.engine.domain.DoorToDoorSale;
...
@Slf4j
public class DoorToDoorSaleParser {

    public static List<DoorToDoorSale> getListFromXml(Document xml) {
        List<DoorToDoorSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            DoorToDoorSale object = new DoorToDoorSale();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 자산규모
                            object.setAssetsScale(itemValue);
                            break;
                        case 59:
                            // 부채총액
                            object.setDebtAmount(itemValue);
                            break;
                        case 61:
                            // 자본금
                        ...
                        case 63:
                            // 판매방식명
                            object.setSaleMethodName(itemValue);
                            break;
                        default:
                            break;
                    }
