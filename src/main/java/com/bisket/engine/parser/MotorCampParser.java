...
@Slf4j
public class MotorCampParser {

    public static List<MotorCamp> getListFromXml(Document xml) {
        List<MotorCamp> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MotorCamp object = new MotorCamp();
