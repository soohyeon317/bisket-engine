...
@Slf4j
public class TobaccoWholesaleParser {

    public static List<TobaccoWholesale> getListFromXml(Document xml) {
        List<TobaccoWholesale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TobaccoWholesale object = new TobaccoWholesale();
