...
@Slf4j
public class SlaughterParser {

    public static List<Slaughter> getListFromXml(Document xml) {
        List<Slaughter> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            Slaughter object = new Slaughter();
