...
@Slf4j
public class AmusementBarParser {

    public static List<AmusementBar> getListFromXml(Document xml) {
        List<AmusementBar> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            AmusementBar object = new AmusementBar();
