...
@Slf4j
public class PhysicalEducationGymParser {

    public static List<PhysicalEducationGym> getListFromXml(Document xml) {
        List<PhysicalEducationGym> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            PhysicalEducationGym object = new PhysicalEducationGym();
