...
@Slf4j
public class FreeEmploymentAgencyParser {

    public static List<FreeEmploymentAgency> getListFromXml(Document xml) {
        List<FreeEmploymentAgency> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FreeEmploymentAgency object = new FreeEmploymentAgency();
