...
@Slf4j
public class SpecializedRecreationParser {

    public static List<SpecializedRecreation> getListFromXml(Document xml) {
        List<SpecializedRecreation> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            SpecializedRecreation object = new SpecializedRecreation();
