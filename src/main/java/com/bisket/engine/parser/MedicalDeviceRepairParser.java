...
@Slf4j
public class MedicalDeviceRepairParser {

    public static List<MedicalDeviceRepair> getListFromXml(Document xml) {
        List<MedicalDeviceRepair> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MedicalDeviceRepair object = new MedicalDeviceRepair();
