...
@Slf4j
public class InstantSaleProductionProcessingParser {

    public static List<InstantSaleProductionProcessing> getListFromXml(Document xml) {
        List<InstantSaleProductionProcessing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            InstantSaleProductionProcessing object = new InstantSaleProductionProcessing();
