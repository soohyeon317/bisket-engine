...
@Slf4j
public class GeneralRestaurantParser {

    public static List<GeneralRestaurant> getListFromXml(Document xml) {
        List<GeneralRestaurant> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GeneralRestaurant object = new GeneralRestaurant();
