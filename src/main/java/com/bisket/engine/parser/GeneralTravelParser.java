...
@Slf4j
public class GeneralTravelParser {

    public static List<GeneralTravel> getListFromXml(Document xml) {
        List<GeneralTravel> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GeneralTravel object = new GeneralTravel();
