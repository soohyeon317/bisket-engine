...
@Slf4j
public class MeterManufacturingParser {

    public static List<MeterManufacturing> getListFromXml(Document xml) {
        List<MeterManufacturing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MeterManufacturing object = new MeterManufacturing();
