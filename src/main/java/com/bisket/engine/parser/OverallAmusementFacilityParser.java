...
@Slf4j
public class OverallAmusementFacilityParser {

    public static List<OverallAmusementFacility> getListFromXml(Document xml) {
        List<OverallAmusementFacility> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            OverallAmusementFacility object = new OverallAmusementFacility();
