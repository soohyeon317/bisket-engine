...
@Slf4j
public class StandardPlasticGarbageBagSaleParser {

    public static List<StandardPlasticGarbageBagSale> getListFromXml(Document xml) {
        List<StandardPlasticGarbageBagSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            StandardPlasticGarbageBagSale object = new StandardPlasticGarbageBagSale();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 63:
                            // 신청일자
                            object.setApplicationDate(itemValue);
                            break;
                        case 65:
                            // 항목값1
                            object.setItemValue1(itemValue);
                            break;
                        default:
                            break;
                    }
