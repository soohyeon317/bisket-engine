...
@Slf4j
public class LivestockArtificialInseminationCenterParser {

    public static List<LivestockArtificialInseminationCenter> getListFromXml(Document xml) {
        List<LivestockArtificialInseminationCenter> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            LivestockArtificialInseminationCenter object = new LivestockArtificialInseminationCenter();
