...
@Slf4j
public class ContainerWrapperProductionParser {

    public static List<ContainerWrapperProduction> getListFromXml(Document xml) {
        List<ContainerWrapperProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ContainerWrapperProduction object = new ContainerWrapperProduction();
