...
import com.bisket.engine.entity.ConstructionWasteTreatment;
...
@Slf4j
public class ConstructionWasteTreatmentParser {

    public static List<ConstructionWasteTreatment> getListFromXml(Document xml) {
        List<ConstructionWasteTreatment> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ConstructionWasteTreatment object = new ConstructionWasteTreatment();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 59:
                            // 폐기물처리업구분명
                            object.setWasteTreatmentBusinessClassificationName(itemValue);
                            break;
                        case 61:
                            // 폐기물처리업별처리구분명
                            object.setWasteTreatmentClassificationName(itemValue);
                            break;
                        case 63:
                            // 폐기물구분명
                            object.setWasteClassificationName(itemValue);
                            break;
                        case 65:
                            // 허용보관량
                            object.setAllowedStorageQuantity(itemValue);
                            break;
                        case 67:
                            // 허용보관량내용
                            object.setAllowedStorageQuantityContent(itemValue);
                            break;
                        default:
                            break;
                    }
