...
@Slf4j
public class GeneralCityGasParser {

    public static List<GeneralCityGas> getListFromXml(Document xml) {
        List<GeneralCityGas> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GeneralCityGas object = new GeneralCityGas();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 배관길이
                            object.setPlumbingLength(itemValue);
                            break;
                        case 59:
                            // 공급규정내용
                            object.setSupplyRuleContent(itemValue);
                            break;
                        case 61:
                            // 가스종류명
                            object.setGasKindName(itemValue);
                            break;
                        default:
                            break;
                    }
