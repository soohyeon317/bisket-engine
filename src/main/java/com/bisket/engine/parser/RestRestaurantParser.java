...
@Slf4j
public class RestRestaurantParser {

    public static List<RestRestaurant> getListFromXml(Document xml) {
        List<RestRestaurant> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            RestRestaurant object = new RestRestaurant();
