...
@Slf4j
public class FoodVendingMachineParser {

    public static List<FoodVendingMachine> getListFromXml(Document xml) {
        List<FoodVendingMachine> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FoodVendingMachine object = new FoodVendingMachine();
