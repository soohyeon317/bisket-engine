...
@Slf4j
public class PotteryProductionParser {

    public static List<PotteryProduction> getListFromXml(Document xml) {
        List<PotteryProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            PotteryProduction object = new PotteryProduction();
