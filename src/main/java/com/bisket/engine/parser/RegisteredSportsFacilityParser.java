...
@Slf4j
public class RegisteredSportsFacilityParser {

    public static List<RegisteredSportsFacility> getListFromXml(Document xml) {
        List<RegisteredSportsFacility> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            RegisteredSportsFacility object = new RegisteredSportsFacility();
