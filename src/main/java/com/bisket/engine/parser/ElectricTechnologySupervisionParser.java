...
import com.bisket.engine.entity.ElectricTechnologySupervision;
...
@Slf4j
public class ElectricTechnologySupervisionParser {

    public static List<ElectricTechnologySupervision> getListFromXml(Document xml) {
        List<ElectricTechnologySupervision> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ElectricTechnologySupervision object = new ElectricTechnologySupervision();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 59:
                            // 설계감리업종류명
                            object.setDesignSupervisionBusinessKindName(itemValue);
                            break;
                        case 61:
                            // 소속국가명
                            object.setCountryName(itemValue);
                            break;
                        case 63:
                            // 실질자본금
                            object.setRealCapital(itemValue);
                            break;
                        default:
                            break;
                    }
