...
@Slf4j
public class GameProductionParser {

    public static List<GameProduction> getListFromXml(Document xml) {
        List<GameProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GameProduction object = new GameProduction();
