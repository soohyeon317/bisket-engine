...
@Slf4j
public class MovieProductionParser {

    public static List<MovieProduction> getListFromXml(Document xml) {
        List<MovieProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MovieProduction object = new MovieProduction();
