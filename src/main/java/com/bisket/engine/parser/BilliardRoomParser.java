...
import com.bisket.engine.entity.BilliardRoom;
...
@Slf4j
public class BilliardRoomParser {

    public static List<BilliardRoom> getListFromXml(Document xml) {
        List<BilliardRoom> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            BilliardRoom object = new BilliardRoom();
