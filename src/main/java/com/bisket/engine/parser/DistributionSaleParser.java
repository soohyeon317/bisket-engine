...
@Slf4j
public class DistributionSaleParser {

    public static List<DistributionSale> getListFromXml(Document xml) {
        List<DistributionSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            DistributionSale object = new DistributionSale();
