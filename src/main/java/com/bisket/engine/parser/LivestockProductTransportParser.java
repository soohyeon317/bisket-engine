...
import com.bisket.engine.entity.LivestockProductTransport;
...
@Slf4j
public class LivestockProductTransportParser {

    public static List<LivestockProductTransport> getListFromXml(Document xml) {
        List<LivestockProductTransport> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            LivestockProductTransport object = new LivestockProductTransport();
