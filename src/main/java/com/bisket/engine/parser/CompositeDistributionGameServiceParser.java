...
import com.bisket.engine.entity.CompositeDistributionGameService;
...
@Slf4j
public class CompositeDistributionGameServiceParser {

    public static List<CompositeDistributionGameService> getListFromXml(Document xml) {
        List<CompositeDistributionGameService> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            CompositeDistributionGameService object = new CompositeDistributionGameService();
