...
@Slf4j
public class GolfCourseParser {

    public static List<GolfCourse> getListFromXml(Document xml) {
        List<GolfCourse> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GolfCourse object = new GolfCourse();
