...
@Slf4j
public class MeatPackagingParser {

    public static List<MeatPackaging> getListFromXml(Document xml) {
        List<MeatPackaging> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MeatPackaging object = new MeatPackaging();
