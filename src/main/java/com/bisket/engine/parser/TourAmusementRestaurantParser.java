...
import com.bisket.engine.entity.TourAmusementRestaurant;
...
@Slf4j
public class TourAmusementRestaurantParser {

    public static List<TourAmusementRestaurant> getListFromXml(Document xml) {
        List<TourAmusementRestaurant> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TourAmusementRestaurant object = new TourAmusementRestaurant();
