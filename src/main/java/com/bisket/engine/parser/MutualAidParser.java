...
@Slf4j
public class MutualAidParser {

    public static List<MutualAid> getListFromXml(Document xml) {
        List<MutualAid> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MutualAid object = new MutualAid();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 민원종류명
                            object.setCivilComplaintKindName(itemValue);
                            break;
                        case 59:
                            // 자본금의 규모
                        ...
                        case 61:
                            // 예치기관명
                            object.setDepositOrganizationName(itemValue);
                            break;
                        case 63:
                            // 공제계약명
                            object.setMutualAidContractName(itemValue);
                            break;
                        case 65:
                            // 공제계약기타명
                            object.setOtherMutualAidContractName(itemValue);
                            break;
                        case 67:
                            // 보험
                            object.setInsurance(itemValue);
                            break;
                        case 69:
                            // 채무지급보증
                            object.setDebtPaymentGuarantee(itemValue);
                            break;
                        default:
                            break;
                    }
