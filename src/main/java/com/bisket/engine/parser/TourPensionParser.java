...
@Slf4j
public class TourPensionParser {

    public static List<TourPension> getListFromXml(Document xml) {
        List<TourPension> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TourPension object = new TourPension();
