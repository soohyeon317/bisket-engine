...
import com.bisket.engine.domain.CivilDefenceWaterSupplyFacility;
...
@Slf4j
public class CivilDefenceWaterSupplyFacilityParser {

    public static List<CivilDefenceWaterSupplyFacility> getListFromXml(Document xml) {
        List<CivilDefenceWaterSupplyFacility> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            CivilDefenceWaterSupplyFacility object = new CivilDefenceWaterSupplyFacility();
