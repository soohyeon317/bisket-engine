...
@Slf4j
public class FoodProductionProcessingParser {

    public static List<FoodProductionProcessing> getListFromXml(Document xml) {
        List<FoodProductionProcessing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FoodProductionProcessing object = new FoodProductionProcessing();
