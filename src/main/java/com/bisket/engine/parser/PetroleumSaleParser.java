...
@Slf4j
public class PetroleumSaleParser {

    public static List<PetroleumSale> getListFromXml(Document xml) {
        List<PetroleumSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            PetroleumSale object = new PetroleumSale();
