...
@Slf4j
public class LivestockSaleParser {

    public static List<LivestockSale> getListFromXml(Document xml) {
        List<LivestockSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            LivestockSale object = new LivestockSale();
