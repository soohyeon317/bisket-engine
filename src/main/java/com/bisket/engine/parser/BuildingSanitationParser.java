...
@Slf4j
public class BuildingSanitationParser {

    public static List<BuildingSanitation> getListFromXml(Document xml) {
        List<BuildingSanitation> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            BuildingSanitation object = new BuildingSanitation();
