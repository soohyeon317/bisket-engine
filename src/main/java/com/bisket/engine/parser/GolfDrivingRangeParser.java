...
@Slf4j
public class GolfDrivingRangeParser {

    public static List<GolfDrivingRange> getListFromXml(Document xml) {
        List<GolfDrivingRange> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GolfDrivingRange object = new GolfDrivingRange();
