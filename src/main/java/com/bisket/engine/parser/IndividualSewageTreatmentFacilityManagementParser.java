...
@Slf4j
public class IndividualSewageTreatmentFacilityManagementParser {

    public static List<IndividualSewageTreatmentFacilityManagement> getListFromXml(Document xml) {
        List<IndividualSewageTreatmentFacilityManagement> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            IndividualSewageTreatmentFacilityManagement object = new IndividualSewageTreatmentFacilityManagement();
