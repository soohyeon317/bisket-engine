...
import com.bisket.engine.entity.Lumbering;
...
@Slf4j
public class LumberingParser {

    public static List<Lumbering> getListFromXml(Document xml) {
        List<Lumbering> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            Lumbering object = new Lumbering();
