...
import com.bisket.engine.domain.CoalBriquetteManufacturing;
...
@Slf4j
public class CoalBriquetteManufacturingParser {

    public static List<CoalBriquetteManufacturing> getListFromXml(Document xml) {
        List<CoalBriquetteManufacturing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            CoalBriquetteManufacturing object = new CoalBriquetteManufacturing();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 저탄장면적
                            object.setCoalYardArea(itemValue);
                            break;
                        case 59:
                            // 철도인입선유무명
                            object.setRailwayIndustrialLineFlag(itemValue);
                            break;
                        case 61:
                            // 사업개시예정일자
                            object.setBusinessOpenScheduleDate(itemValue);
                            break;
                        case 63:
                            // 윤전기생산시설
                            object.setRotaryPressProductionFacility(itemValue);
                            break;
                        default:
                            break;
                    }
