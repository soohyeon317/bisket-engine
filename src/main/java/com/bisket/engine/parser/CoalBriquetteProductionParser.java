...
@Slf4j
public class CoalBriquetteProductionParser {

    public static List<CoalBriquetteProduction> getListFromXml(Document xml) {
        List<CoalBriquetteProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            CoalBriquetteProduction object = new CoalBriquetteProduction();
