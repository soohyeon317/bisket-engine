...
import com.bisket.engine.domain.FoodManufacturingProcessing;
...
@Slf4j
public class FoodManufacturingProcessingParser {

    public static List<FoodManufacturingProcessing> getListFromXml(Document xml) {
        List<FoodManufacturingProcessing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FoodManufacturingProcessing object = new FoodManufacturingProcessing();
