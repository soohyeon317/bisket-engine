...
@Slf4j
public class VideoRoomParser {

    public static List<VideoRoom> getListFromXml(Document xml) {
        List<VideoRoom> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            VideoRoom object = new VideoRoom();
