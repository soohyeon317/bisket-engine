...
@Slf4j
public class ContainerWrapperManufacturingParser {

    public static List<ContainerWrapperManufacturing> getListFromXml(Document xml) {
        List<ContainerWrapperManufacturing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ContainerWrapperManufacturing object = new ContainerWrapperManufacturing();
