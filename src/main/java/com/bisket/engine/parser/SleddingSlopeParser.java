...
import com.bisket.engine.entity.SleddingSlope;
...
@Slf4j
public class SleddingSlopeParser {

    public static List<SleddingSlope> getListFromXml(Document xml) {
        List<SleddingSlope> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            SleddingSlope object = new SleddingSlope();
