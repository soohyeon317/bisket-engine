...
import com.bisket.engine.domain.DomesticTravel;
...
@Slf4j
public class DomesticTravelParser {

    public static List<DomesticTravel> getListFromXml(Document xml) {
        List<DomesticTravel> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            DomesticTravel object = new DomesticTravel();
