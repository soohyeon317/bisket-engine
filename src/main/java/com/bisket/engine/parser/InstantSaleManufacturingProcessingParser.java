...
@Slf4j
public class InstantSaleManufacturingProcessingParser {

    public static List<InstantSaleManufacturingProcessing> getListFromXml(Document xml) {
        List<InstantSaleManufacturingProcessing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            InstantSaleManufacturingProcessing object = new InstantSaleManufacturingProcessing();
