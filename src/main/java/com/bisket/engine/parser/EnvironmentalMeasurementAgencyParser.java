...
@Slf4j
public class EnvironmentalMeasurementAgencyParser {

    public static List<EnvironmentalMeasurementAgency> getListFromXml(Document xml) {
        List<EnvironmentalMeasurementAgency> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            EnvironmentalMeasurementAgency object = new EnvironmentalMeasurementAgency();
