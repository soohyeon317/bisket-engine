...
import com.bisket.engine.entity.ParamedicalService;
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 63:
                            // 보조종업원수
                            object.setAssistantEmployeeCount(itemValue);
                            break;
                        case 65:
                            // 시설관리자수
                            object.setFacilityManagerCount(itemValue);
                            break;
                        case 67:
                            // 기타종업원수
                            object.setOtherEmployeeCount(itemValue);
                            break;
                        case 69:
                            // 병상수
