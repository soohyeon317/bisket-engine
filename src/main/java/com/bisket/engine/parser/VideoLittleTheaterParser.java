...
import com.bisket.engine.entity.VideoLittleTheater;
...
@Slf4j
public class VideoLittleTheaterParser {

    public static List<VideoLittleTheater> getListFromXml(Document xml) {
        List<VideoLittleTheater> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            VideoLittleTheater object = new VideoLittleTheater();
