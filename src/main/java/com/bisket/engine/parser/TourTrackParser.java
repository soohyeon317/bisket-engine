...
@Slf4j
public class TourTrackParser {

    public static List<TourTrack> getListFromXml(Document xml) {
        List<TourTrack> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TourTrack object = new TourTrack();
