...
import com.bisket.engine.entity.GroupFoodServiceFoodSale;
...
@Slf4j
public class GroupFoodServiceFoodSaleParser {

    public static List<GroupFoodServiceFoodSale> getListFromXml(Document xml) {
        List<GroupFoodServiceFoodSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GroupFoodServiceFoodSale object = new GroupFoodServiceFoodSale();
