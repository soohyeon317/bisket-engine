...
import com.bisket.engine.entity.DentalLaboratory;
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 기공용레스수
                            object.setLaboratoryLatheCount(itemValue);
                            break;
                        case 59:
                            // 원심주조기수
                            object.setCentrifugalCastingMachineCount(itemValue);
                            break;
                        case 61:
                            // 기공용모터수
                            object.setLaboratoryMotorCount(itemValue);
                            break;
                        case 63:
                            // 아세틸렌수
                            object.setAcetyleneCount(itemValue);
                            break;
                        case 65:
                            // 치과용프레스수
                            object.setDentalPressCount(itemValue);
                            break;
                        case 67:
                            // 전기로수
                            object.setElectricFurnaceCount(itemValue);
                            break;
                        case 69:
                            // 포셀린로수
                            object.setPorcelainFurnaceCount(itemValue);
                            break;
                        case 71:
                            // 초음파청소기수
                            object.setUltrasonicCleanerCount(itemValue);
                            break;
                        case 73:
                            // 서베이어수
                            object.setSurveyorCount(itemValue);
                            break;
                        case 75:
                            // 진동기수
                            object.setVibratorCount(itemValue);
                            break;
                        case 77:
                            // 트리머수
                            object.setTrimmerCount(itemValue);
                            break;
                        case 79:
                            // 기공용컴프레서수
                            object.setLaboratoryCompressorCount(itemValue);
                            break;
                        case 81:
                            // 샌드기수
                            object.setSanderCount(itemValue);
                            break;
                        case 83:
                            // 진공매몰기수
                            object.setVacuumMixerCount(itemValue);
                            break;
                        case 85:
                            // 핀덱스수
                            object.setPindexCount(itemValue);
                            break;
                        default:
                            break;
                    }
