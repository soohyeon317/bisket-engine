...
import com.bisket.engine.domain.EnvironmentalConstruction;
...
@Slf4j
public class EnvironmentalConstructionParser {

    public static List<EnvironmentalConstruction> getListFromXml(Document xml) {
        List<EnvironmentalConstruction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            EnvironmentalConstruction object = new EnvironmentalConstruction();
