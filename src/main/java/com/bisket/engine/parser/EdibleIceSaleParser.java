...
@Slf4j
public class EdibleIceSaleParser {

    public static List<EdibleIceSale> getListFromXml(Document xml) {
        List<EdibleIceSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            EdibleIceSale object = new EdibleIceSale();
