...
public class PharmacyParser {
    ...
    public static List<Pharmacy> getListFromXml(Document xml) {
        List<Pharmacy> objectList = new ArrayList<>();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 약국영업면적
                            object.setBusinessArea(itemValue);
                            break;
                        case 59:
                            // 지정일자
