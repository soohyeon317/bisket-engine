...
@Slf4j
public class LivestockExcretaCollectionTransportParser {

    public static List<LivestockExcretaCollectionTransport> getListFromXml(Document xml) {
        List<LivestockExcretaCollectionTransport> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            LivestockExcretaCollectionTransport object = new LivestockExcretaCollectionTransport();
