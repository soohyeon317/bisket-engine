...
import com.bisket.engine.entity.AnimalMedicineWholesaleStore;
...
@Slf4j
public class AnimalMedicineWholesaleStoreParser {

    public static List<AnimalMedicineWholesaleStore> getListFromXml(Document xml) {
        List<AnimalMedicineWholesaleStore> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            AnimalMedicineWholesaleStore object = new AnimalMedicineWholesaleStore();
