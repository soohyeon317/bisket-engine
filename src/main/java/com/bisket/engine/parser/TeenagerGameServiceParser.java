...
@Slf4j
public class TeenagerGameServiceParser {

    public static List<TeenagerGameService> getListFromXml(Document xml) {
        List<TeenagerGameService> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TeenagerGameService object = new TeenagerGameService();
