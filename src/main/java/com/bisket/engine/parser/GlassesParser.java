...
public class GlassesParser {
    ...
    public static List<Glasses> getListFromXml(Document xml) {
        List<Glasses> objectList = new ArrayList<>();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 시력표수
                            object.setEyesightChartCount(itemValue);
                            break;
                        case 59:
                            // 표본렌즈수
                            object.setSampleLensCount(itemValue);
                            break;
                        case 61:
                            // 측정의자수
                            object.setMeasurementChairCount(itemValue);
                            break;
                        case 63:
                            // 동공거리측정기수
                            object.setPupillostatometerCount(itemValue);
                            break;
                        case 65:
                            // 정점굴절계기수
                            object.setVertexRefractometerCount(itemValue);
                            break;
                        case 67:
                            // 조제용연마기수
                            object.setPreparativeGrinderCount(itemValue);
                            break;
                        case 69:
                            // 렌즈절단기수
                            object.setLensCutterCount(itemValue);
                            break;
                        case 71:
                            // 가열기수
                            object.setHeaterCount(itemValue);
                            break;
                        case 73:
                            // 안경세척기수
                            object.setGlassesWasherCount(itemValue);
                            break;
                        case 75:
                            // 총면적
