...
@Slf4j
public class MusicRecordVideoDistributionParser {

    public static List<MusicRecordVideoDistribution> getListFromXml(Document xml) {
        List<MusicRecordVideoDistribution> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MusicRecordVideoDistribution object = new MusicRecordVideoDistribution();
