...
import com.bisket.engine.entity.FuneralDirectorEducationOrganization;
...
@Slf4j
public class FuneralDirectorEducationOrganizationParser {

    public static List<FuneralDirectorEducationOrganization> getListFromXml(Document xml) {
        List<FuneralDirectorEducationOrganization> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FuneralDirectorEducationOrganization object = new FuneralDirectorEducationOrganization();
