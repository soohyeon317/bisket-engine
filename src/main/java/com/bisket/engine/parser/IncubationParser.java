...
@Slf4j
public class IncubationParser {

    public static List<Incubation> getListFromXml(Document xml) {
        List<Incubation> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            Incubation object = new Incubation();
