...
import com.bisket.engine.entity.LivestockProcessing;
...
@Slf4j
public class LivestockProcessingParser {

    public static List<LivestockProcessing> getListFromXml(Document xml) {
        List<LivestockProcessing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            LivestockProcessing object = new LivestockProcessing();
