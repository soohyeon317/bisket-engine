...
@Slf4j
public class SkiResortParser {

    public static List<SkiResort> getListFromXml(Document xml) {
        List<SkiResort> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            SkiResort object = new SkiResort();
