...
import com.bisket.engine.entity.ForeignerAmusementRestaurant;
...
@Slf4j
public class ForeignerAmusementRestaurantParser {

    public static List<ForeignerAmusementRestaurant> getListFromXml(Document xml) {
        List<ForeignerAmusementRestaurant> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ForeignerAmusementRestaurant object = new ForeignerAmusementRestaurant();
