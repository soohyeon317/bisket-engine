...
@Slf4j
public class LivestockExcretaDischargeFacilityManagementParser {

    public static List<LivestockExcretaDischargeFacilityManagement> getListFromXml(Document xml) {
        List<LivestockExcretaDischargeFacilityManagement> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            LivestockExcretaDischargeFacilityManagement object = new LivestockExcretaDischargeFacilityManagement();
