...
import com.bisket.engine.domain.HealthFunctionalFoodGeneralSale;
...
@Slf4j
public class HealthFunctionalFoodGeneralSaleParser {

    public static List<HealthFunctionalFoodGeneralSale> getListFromXml(Document xml) {
        List<HealthFunctionalFoodGeneralSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            HealthFunctionalFoodGeneralSale object = new HealthFunctionalFoodGeneralSale();
