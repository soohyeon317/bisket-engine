...
@Slf4j
public class InternationalConferencePlanningParser {

    public static List<InternationalConferencePlanning> getListFromXml(Document xml) {
        List<InternationalConferencePlanning> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            InternationalConferencePlanning object = new InternationalConferencePlanning();
