...
import com.bisket.engine.entity.MusicRecordVideoProduction;
...
@Slf4j
public class MusicRecordVideoProductionParser {

    public static List<MusicRecordVideoProduction> getListFromXml(Document xml) {
        List<MusicRecordVideoProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MusicRecordVideoProduction object = new MusicRecordVideoProduction();
