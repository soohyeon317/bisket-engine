...
@Slf4j
public class PhysicalFitnessCenterParser {

    public static List<PhysicalFitnessCenter> getListFromXml(Document xml) {
        List<PhysicalFitnessCenter> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            PhysicalFitnessCenter object = new PhysicalFitnessCenter();
