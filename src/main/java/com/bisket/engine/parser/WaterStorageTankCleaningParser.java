...
@Slf4j
public class WaterStorageTankCleaningParser {

    public static List<WaterStorageTankCleaning> getListFromXml(Document xml) {
        List<WaterStorageTankCleaning> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            WaterStorageTankCleaning object = new WaterStorageTankCleaning();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 업무구분
                            object.setJobClassification(itemValue);
                            break;
                        case 59:
                            // 건축물명
                            object.setBuildingName(itemValue);
                            break;
                        case 61:
                            // 건축물연면적
                        ...
                        case 63:
                            // 건축물상태명
                            object.setBuildingStatusName(itemValue);
                            break;
                        case 65:
                            // 청소대상시작일자
                            object.setCleaningTargetStartDate(itemValue);
                            break;
                        case 67:
                            // 청소대상종료일자
                            object.setCleaningTargetEndDate(itemValue);
                            break;
                        case 69:
                            // 휴업폐지사유
                            object.setIdleCloseReason(itemValue);
                            break;
                        case 71:
                            // 업무구분명
                            object.setJobClassificationName(itemValue);
                            break;
                        default:
                            break;
                    }
