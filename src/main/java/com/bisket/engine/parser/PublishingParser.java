...
@Slf4j
public class PublishingParser {

    public static List<Publishing> getListFromXml(Document xml) {
        List<Publishing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            Publishing object = new Publishing();
