...
@Slf4j
public class PopularCultureArtsPlanningParser {

    public static List<PopularCultureArtsPlanning> getListFromXml(Document xml) {
        List<PopularCultureArtsPlanning> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            PopularCultureArtsPlanning object = new PopularCultureArtsPlanning();
