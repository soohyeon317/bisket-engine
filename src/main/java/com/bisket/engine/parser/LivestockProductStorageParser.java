...
@Slf4j
public class LivestockProductStorageParser {

    public static List<LivestockProductStorage> getListFromXml(Document xml) {
        List<LivestockProductStorage> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            LivestockProductStorage object = new LivestockProductStorage();
