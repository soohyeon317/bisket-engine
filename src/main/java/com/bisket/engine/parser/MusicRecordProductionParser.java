...
@Slf4j
public class MusicRecordProductionParser {

    public static List<MusicRecordProduction> getListFromXml(Document xml) {
        List<MusicRecordProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MusicRecordProduction object = new MusicRecordProduction();
