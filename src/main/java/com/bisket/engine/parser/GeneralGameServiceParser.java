...
@Slf4j
public class GeneralGameServiceParser {

    public static List<GeneralGameService> getListFromXml(Document xml) {
        List<GeneralGameService> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GeneralGameService object = new GeneralGameService();
