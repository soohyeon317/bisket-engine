...
@Slf4j
public class ElectricTechnologyDesignParser {

    public static List<ElectricTechnologyDesign> getListFromXml(Document xml) {
        List<ElectricTechnologyDesign> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ElectricTechnologyDesign object = new ElectricTechnologyDesign();
