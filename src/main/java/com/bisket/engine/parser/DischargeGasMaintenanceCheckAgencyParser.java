...
@Slf4j
public class DischargeGasMaintenanceCheckAgencyParser {

    public static List<DischargeGasMaintenanceCheckAgency> getListFromXml(Document xml) {
        List<DischargeGasMaintenanceCheckAgency> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            DischargeGasMaintenanceCheckAgency object = new DischargeGasMaintenanceCheckAgency();
