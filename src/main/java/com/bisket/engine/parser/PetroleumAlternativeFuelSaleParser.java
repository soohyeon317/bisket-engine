...
import com.bisket.engine.entity.PetroleumAlternativeFuelSale;
...
@Slf4j
public class PetroleumAlternativeFuelSaleParser {

    public static List<PetroleumAlternativeFuelSale> getListFromXml(Document xml) {
        List<PetroleumAlternativeFuelSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            PetroleumAlternativeFuelSale object = new PetroleumAlternativeFuelSale();
