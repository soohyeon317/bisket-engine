...
@Slf4j
public class TobaccoRetailParser {

    public static List<TobaccoRetail> getListFromXml(Document xml) {
        List<TobaccoRetail> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TobaccoRetail object = new TobaccoRetail();
