...
@Slf4j
public class MeterRepairParser {

    public static List<MeterRepair> getListFromXml(Document xml) {
        List<MeterRepair> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MeterRepair object = new MeterRepair();
