...
@Slf4j
public class VideoDistributionParser {

    public static List<VideoDistribution> getListFromXml(Document xml) {
        List<VideoDistribution> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            VideoDistribution object = new VideoDistribution();
