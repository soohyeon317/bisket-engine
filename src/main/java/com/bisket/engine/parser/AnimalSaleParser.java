...
@Slf4j
public class AnimalSaleParser {

    public static List<AnimalSale> getListFromXml(Document xml) {
        List<AnimalSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            AnimalSale object = new AnimalSale();
