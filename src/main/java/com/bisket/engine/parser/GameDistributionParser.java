...
@Slf4j
public class GameDistributionParser {

    public static List<GameDistribution> getListFromXml(Document xml) {
        List<GameDistribution> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GameDistribution object = new GameDistribution();
