...
import com.bisket.engine.domain.GeneralAmusementFacility;
...
@Slf4j
public class GeneralAmusementFacilityParser {

    public static List<GeneralAmusementFacility> getListFromXml(Document xml) {
        List<GeneralAmusementFacility> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GeneralAmusementFacility object = new GeneralAmusementFacility();
