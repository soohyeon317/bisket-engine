...
@Slf4j
public class ContainerFreezerSpecificFacilityParser {

    public static List<ContainerFreezerSpecificFacility> getListFromXml(Document xml) {
        List<ContainerFreezerSpecificFacility> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ContainerFreezerSpecificFacility object = new ContainerFreezerSpecificFacility();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 설비규격
                            object.setFacilityStandard(itemValue);
                            break;
                        default:
                            break;
                    }
