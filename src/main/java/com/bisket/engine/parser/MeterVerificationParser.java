...
@Slf4j
public class MeterVerificationParser {

    public static List<MeterVerification> getListFromXml(Document xml) {
        List<MeterVerification> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MeterVerification object = new MeterVerification();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 사무소전화번호
                            object.setOfficePhoneNumber(itemValue);
                            break;
                        case 59:
                            // 사업장전화번호
                            object.setBusinessPlacePhoneNumber(itemValue);
                            break;
                        default:
                            break;
                    }
