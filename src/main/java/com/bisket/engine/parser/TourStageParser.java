...
@Slf4j
public class TourStageParser {

    public static List<TourStage> getListFromXml(Document xml) {
        List<TourStage> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TourStage object = new TourStage();
