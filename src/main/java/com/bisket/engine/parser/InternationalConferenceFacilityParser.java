...
import com.bisket.engine.entity.InternationalConferenceFacility;
...
@Slf4j
public class InternationalConferenceFacilityParser {

    public static List<InternationalConferenceFacility> getListFromXml(Document xml) {
        List<InternationalConferenceFacility> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            InternationalConferenceFacility object = new InternationalConferenceFacility();
