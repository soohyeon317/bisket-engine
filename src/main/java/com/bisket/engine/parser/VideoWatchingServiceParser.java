...
@Slf4j
public class VideoWatchingServiceParser {

    public static List<VideoWatchingService> getListFromXml(Document xml) {
        List<VideoWatchingService> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            VideoWatchingService object = new VideoWatchingService();
