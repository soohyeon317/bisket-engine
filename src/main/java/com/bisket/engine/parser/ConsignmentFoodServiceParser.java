...
import com.bisket.engine.entity.ConsignmentFoodService;
...
@Slf4j
public class ConsignmentFoodServiceParser {

    public static List<ConsignmentFoodService> getListFromXml(Document xml) {
        List<ConsignmentFoodService> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ConsignmentFoodService object = new ConsignmentFoodService();
