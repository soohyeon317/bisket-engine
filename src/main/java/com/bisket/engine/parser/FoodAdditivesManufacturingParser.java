...
@Slf4j
public class FoodAdditivesManufacturingParser {

    public static List<FoodAdditivesManufacturing> getListFromXml(Document xml) {
        List<FoodAdditivesManufacturing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FoodAdditivesManufacturing object = new FoodAdditivesManufacturing();
