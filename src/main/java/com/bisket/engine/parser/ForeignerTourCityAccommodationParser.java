...
@Slf4j
public class ForeignerTourCityAccommodationParser {

    public static List<ForeignerTourCityAccommodation> getListFromXml(Document xml) {
        List<ForeignerTourCityAccommodation> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ForeignerTourCityAccommodation object = new ForeignerTourCityAccommodation();
