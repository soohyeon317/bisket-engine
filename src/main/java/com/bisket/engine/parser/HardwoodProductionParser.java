...
import com.bisket.engine.entity.HardwoodProduction;
...
@Slf4j
public class HardwoodProductionParser {

    public static List<HardwoodProduction> getListFromXml(Document xml) {
        List<HardwoodProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            HardwoodProduction object = new HardwoodProduction();
