...
import com.bisket.engine.entity.AirPollutantDischargeFacilityInstallation;
...
@Slf4j
public class AirPollutantDischargeFacilityInstallationParser {

    public static List<AirPollutantDischargeFacilityInstallation> getListFromXml(Document xml) {
        List<AirPollutantDischargeFacilityInstallation> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            AirPollutantDischargeFacilityInstallation object = new AirPollutantDischargeFacilityInstallation();
