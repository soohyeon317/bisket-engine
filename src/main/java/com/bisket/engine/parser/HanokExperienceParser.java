...
import com.bisket.engine.entity.HanokExperience;
...
@Slf4j
public class HanokExperienceParser {

    public static List<HanokExperience> getListFromXml(Document xml) {
        List<HanokExperience> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            HanokExperience object = new HanokExperience();
