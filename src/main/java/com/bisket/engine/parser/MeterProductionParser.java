...
import com.bisket.engine.domain.MeterProduction;
...
@Slf4j
public class MeterProductionParser {

    public static List<MeterProduction> getListFromXml(Document xml) {
        List<MeterProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MeterProduction object = new MeterProduction();
