...
import com.bisket.engine.entity.SpecificPressureGas;
...
@Slf4j
public class SpecificPressureGasParser {

    public static List<SpecificPressureGas> getListFromXml(Document xml) {
        List<SpecificPressureGas> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            SpecificPressureGas object = new SpecificPressureGas();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 사용목적
                            object.setUsePurpose(itemValue);
                            break;
                        case 59:
                            // 사용방법
                            object.setUseMethod(itemValue);
                            break;
                        case 61:
                            // 월사용량
                            object.setMonthlyUsage(itemValue);
                            break;
                        case 63:
                            // 수용정원수
                            object.setCapacity(itemValue);
                            break;
                        case 65:
                            // 시설사용여부
                            object.setFacilityUseFlag(itemValue);
                            break;
                        default:
                            break;
                    }
