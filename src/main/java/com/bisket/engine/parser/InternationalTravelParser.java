...
@Slf4j
public class InternationalTravelParser {

    public static List<InternationalTravel> getListFromXml(Document xml) {
        List<InternationalTravel> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            InternationalTravel object = new InternationalTravel();
