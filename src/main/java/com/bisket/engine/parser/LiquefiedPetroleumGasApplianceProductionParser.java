...
@Slf4j
public class LiquefiedPetroleumGasApplianceProductionParser {

    public static List<LiquefiedPetroleumGasApplianceProduction> getListFromXml(Document xml) {
        List<LiquefiedPetroleumGasApplianceProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            LiquefiedPetroleumGasApplianceProduction object = new LiquefiedPetroleumGasApplianceProduction();
