...
@Slf4j
public class FeedProductionParser {

    public static List<FeedProduction> getListFromXml(Document xml) {
        List<FeedProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FeedProduction object = new FeedProduction();
