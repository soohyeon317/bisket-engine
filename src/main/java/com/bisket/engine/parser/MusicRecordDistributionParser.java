...
@Slf4j
public class MusicRecordDistributionParser {

    public static List<MusicRecordDistribution> getListFromXml(Document xml) {
        List<MusicRecordDistribution> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MusicRecordDistribution object = new MusicRecordDistribution();
