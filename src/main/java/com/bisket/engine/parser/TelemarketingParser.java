...
@Slf4j
public class TelemarketingParser {

    public static List<Telemarketing> getListFromXml(Document xml) {
        List<Telemarketing> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            Telemarketing object = new Telemarketing();
