...
import com.bisket.engine.domain.OverallRecreation;
...
@Slf4j
public class OverallRecreationParser {

    public static List<OverallRecreation> getListFromXml(Document xml) {
        List<OverallRecreation> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            OverallRecreation object = new OverallRecreation();
