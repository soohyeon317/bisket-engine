...
@Slf4j
public class MovieScreeningParser {

    public static List<MovieScreening> getListFromXml(Document xml) {
        List<MovieScreening> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MovieScreening object = new MovieScreening();
