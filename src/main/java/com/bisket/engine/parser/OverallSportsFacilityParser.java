...
import com.bisket.engine.domain.OverallSportsFacility;
...
@Slf4j
public class OverallSportsFacilityParser {

    public static List<OverallSportsFacility> getListFromXml(Document xml) {
        List<OverallSportsFacility> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            OverallSportsFacility object = new OverallSportsFacility();
