...
@Slf4j
public class TourAccommodationParser {

    public static List<TourAccommodation> getListFromXml(Document xml) {
        List<TourAccommodation> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TourAccommodation object = new TourAccommodation();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 127:
                            // 관광숙박업상세명
                            object.setTourAccommodationBusinessDetailedName(itemValue);
                            break;
                        default:
                            break;
                    }
