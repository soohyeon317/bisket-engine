...
import com.bisket.engine.entity.OtherFoodSale;
...
@Slf4j
public class OtherFoodSaleParser {

    public static List<OtherFoodSale> getListFromXml(Document xml) {
        List<OtherFoodSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            OtherFoodSale object = new OtherFoodSale();
