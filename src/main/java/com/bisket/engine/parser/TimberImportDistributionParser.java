...
import com.bisket.engine.entity.TimberImportDistribution;
...
@Slf4j
public class TimberImportDistributionParser {

    public static List<TimberImportDistribution> getListFromXml(Document xml) {
        List<TimberImportDistribution> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TimberImportDistribution object = new TimberImportDistribution();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 목재생산업구분코드명
                            object.setTimberProductionBusinessClassificationCode(itemValue);
                            break;
                        case 59:
                            // 목재생산업종류명
                            object.setTimberProductionBusinessKindName(itemValue);
                            break;
                        case 61:
                            // 취급목재제품
                            object.setHandlingTimberProduct(itemValue);
                            break;
                        case 63:
                            // 인력보유현황
                            object.setManpowerPossessionStatus(itemValue);
                            break;
                        case 65:
                            // 년간생산량
                            object.setAnnualProduction(itemValue);
                            break;
                        case 67:
                            // 자본금
                        ...
                        case 69:
                            // 상태구분명
                            object.setStatusClassificationName(itemValue);
                            break;
                        default:
                            break;
                    }
