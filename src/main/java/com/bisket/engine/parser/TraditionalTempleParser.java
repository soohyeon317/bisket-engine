...
@Slf4j
public class TraditionalTempleParser {

    public static List<TraditionalTemple> getListFromXml(Document xml) {
        List<TraditionalTemple> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TraditionalTemple object = new TraditionalTemple();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 승려수
                            object.setBuddhistMonkCount(itemValue);
                            break;
                        case 59:
                            // 신도수
                            object.setBelieverCount(itemValue);
                            break;
                        case 61:
                            // 창립연대
                            object.setEstablishmentEra(itemValue);
                            break;
                        case 63:
                            // 유래연혁
                            object.setOriginHistory(itemValue);
                            break;
                        case 65:
                            // 지정취소
                            object.setAppointmentCancel(itemValue);
                            break;
                        case 67:
                            // 지정취소일자
                        ...
                        case 69:
                            // 지정취소사유
                            object.setAppointmentCancelReason(itemValue);
                            break;
                        case 71:
                            // 전통사찰명
                            object.setTraditionalTempleName(itemValue);
                            break;
                        default:
                            break;
                    }
