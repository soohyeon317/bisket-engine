...
@Slf4j
public class BathhouseParser {

    public static List<Bathhouse> getListFromXml(Document xml) {
        List<Bathhouse> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            Bathhouse object = new Bathhouse();
