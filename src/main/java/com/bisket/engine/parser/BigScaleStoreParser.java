...
@Slf4j
public class BigScaleStoreParser {

    public static List<BigScaleStore> getListFromXml(Document xml) {
        List<BigScaleStore> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            BigScaleStore object = new BigScaleStore();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 점포구분명
                            object.setStoreClassificationName(itemValue);
                            break;
                        default:
                            break;
                    }
