...
@Slf4j
public class AdministrativeAgentParser {

    public static List<AdministrativeAgent> getListFromXml(Document xml) {
        List<AdministrativeAgent> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            AdministrativeAgent object = new AdministrativeAgent();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 신고일자
                            object.setRegistrationDate(itemValue);
                            break;
                        case 59:
                            // 변경순번
                            object.setChangeTurn(itemValue);
                            break;
                        case 61:
                            // 변경처리일
                            object.setChangeDate(itemValue);
                            break;
                        case 63:
                            // 행정사종류
                            object.setAdministrativeAgentKind(itemValue);
                            break;
                        default:
                            break;
                    }
