...
import com.bisket.engine.domain.UndergroundWaterConstruction;
...
@Slf4j
public class UndergroundWaterConstructionParser {

    public static List<UndergroundWaterConstruction> getListFromXml(Document xml) {
        List<UndergroundWaterConstruction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            UndergroundWaterConstruction object = new UndergroundWaterConstruction();
