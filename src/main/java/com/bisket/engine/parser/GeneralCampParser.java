...
@Slf4j
public class GeneralCampParser {

    public static List<GeneralCamp> getListFromXml(Document xml) {
        List<GeneralCamp> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GeneralCamp object = new GeneralCamp();
