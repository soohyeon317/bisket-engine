...
@Slf4j
public class AnimalHospitalParser {

    public static List<AnimalHospital> getListFromXml(Document xml) {
        List<AnimalHospital> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            AnimalHospital object = new AnimalHospital();
