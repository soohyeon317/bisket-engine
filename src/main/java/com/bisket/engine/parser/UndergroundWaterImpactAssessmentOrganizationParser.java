...
@Slf4j
public class UndergroundWaterImpactAssessmentOrganizationParser {

    public static List<UndergroundWaterImpactAssessmentOrganization> getListFromXml(Document xml) {
        List<UndergroundWaterImpactAssessmentOrganization> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            UndergroundWaterImpactAssessmentOrganization object = new UndergroundWaterImpactAssessmentOrganization();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 전문인력총수
                            object.setSpecialistCount(itemValue);
                            break;
                        case 59:
                            // 자본금
                        ...
                        case 61:
                            // 시설장비
                            object.setFacilityEquipment(itemValue);
                            break;
                        case 63:
                            // 타기관이전여부
                            object.setOtherOrganizationTransferFlag(itemValue);
                            break;
                        default:
                            break;
                    }
