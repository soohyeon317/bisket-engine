...
@Slf4j
public class LivestockFarmingParser {

    public static List<LivestockFarming> getListFromXml(Document xml) {
        List<LivestockFarming> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            LivestockFarming object = new LivestockFarming();
