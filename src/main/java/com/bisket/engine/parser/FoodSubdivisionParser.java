...
import com.bisket.engine.entity.FoodSubdivision;
...
@Slf4j
public class FoodSubdivisionParser {

    public static List<FoodSubdivision> getListFromXml(Document xml) {
        List<FoodSubdivision> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FoodSubdivision object = new FoodSubdivision();
