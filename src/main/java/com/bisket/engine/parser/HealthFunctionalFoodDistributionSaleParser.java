...
@Slf4j
public class HealthFunctionalFoodDistributionSaleParser {

    public static List<HealthFunctionalFoodDistributionSale> getListFromXml(Document xml) {
        List<HealthFunctionalFoodDistributionSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            HealthFunctionalFoodDistributionSale object = new HealthFunctionalFoodDistributionSale();
