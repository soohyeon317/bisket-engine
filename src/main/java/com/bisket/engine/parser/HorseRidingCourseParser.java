...
@Slf4j
public class HorseRidingCourseParser {

    public static List<HorseRidingCourse> getListFromXml(Document xml) {
        List<HorseRidingCourse> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            HorseRidingCourse object = new HorseRidingCourse();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 59:
                            // 공사립구분명
                            object.setPublicPrivateClassificationName(itemValue);
                            break;
                        case 61:
                            // 보험가입여부코드
                            object.setInsuranceFlag(itemValue);
                            break;
                        case 63:
                            // 지도자수
                            object.setInstructorCount(itemValue);
                            break;
                        case 65:
                            // 건축물동수
                            object.setBuildingDongCount(itemValue);
                            break;
                        case 67:
                            // 건축물연면적
                        ...
                        case 69:
                            // 회원모집총인원
                            object.setMemberRecruitmentCapacity(itemValue);
                            break;
                        case 71:
                            // 세부업종명
