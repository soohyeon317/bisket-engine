...
@Slf4j
public class WaterSupplyConstructionAgencyParser {

    public static List<WaterSupplyConstructionAgency> getListFromXml(Document xml) {
        List<WaterSupplyConstructionAgency> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            WaterSupplyConstructionAgency object = new WaterSupplyConstructionAgency();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 59:
                            // 허가기간_시작일자
                            object.setApprovalStartDate(itemValue);
                            break;
                        case 61:
                            // 허가기간_종료일자
                            object.setApprovalEndDate(itemValue);
                            break;
                        default:
                            break;
                    }
