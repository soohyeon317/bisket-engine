...
@Slf4j
public class GroupFoodServiceParser {

    public static List<GroupFoodService> getListFromXml(Document xml) {
        List<GroupFoodService> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            GroupFoodService object = new GroupFoodService();
