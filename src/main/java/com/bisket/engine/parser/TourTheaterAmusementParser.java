...
import com.bisket.engine.domain.TourTheaterAmusement;
...
@Slf4j
public class TourTheaterAmusementParser {

    public static List<TourTheaterAmusement> getListFromXml(Document xml) {
        List<TourTheaterAmusement> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TourTheaterAmusement object = new TourTheaterAmusement();
