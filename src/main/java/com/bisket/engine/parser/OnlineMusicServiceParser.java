...
import com.bisket.engine.entity.OnlineMusicService;
...
@Slf4j
public class OnlineMusicServiceParser {

    public static List<OnlineMusicService> getListFromXml(Document xml) {
        List<OnlineMusicService> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            OnlineMusicService object = new OnlineMusicService();
