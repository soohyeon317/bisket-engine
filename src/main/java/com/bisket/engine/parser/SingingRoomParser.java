...
@Slf4j
public class SingingRoomParser {

    public static List<SingingRoom> getListFromXml(Document xml) {
        List<SingingRoom> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            SingingRoom object = new SingingRoom();
