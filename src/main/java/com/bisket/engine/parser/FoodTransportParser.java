...
@Slf4j
public class FoodTransportParser {

    public static List<FoodTransport> getListFromXml(Document xml) {
        List<FoodTransport> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FoodTransport object = new FoodTransport();
