...
import com.bisket.engine.domain.MartialArtGym;
...
@Slf4j
public class MartialArtGymParser {

    public static List<MartialArtGym> getListFromXml(Document xml) {
        List<MartialArtGym> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MartialArtGym object = new MartialArtGym();
