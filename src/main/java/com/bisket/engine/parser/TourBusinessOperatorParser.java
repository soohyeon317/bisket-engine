...
@Slf4j
public class TourBusinessOperatorParser {

    public static List<TourBusinessOperator> getListFromXml(Document xml) {
        List<TourBusinessOperator> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TourBusinessOperator object = new TourBusinessOperator();
