...
@Slf4j
public class MilkCollectionParser {

    public static List<MilkCollection> getListFromXml(Document xml) {
        List<MilkCollection> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MilkCollection object = new MilkCollection();
