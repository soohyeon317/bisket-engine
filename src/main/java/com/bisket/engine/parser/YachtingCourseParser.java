...
@Slf4j
public class YachtingCourseParser {

    public static List<YachtingCourse> getListFromXml(Document xml) {
        List<YachtingCourse> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            YachtingCourse object = new YachtingCourse();
