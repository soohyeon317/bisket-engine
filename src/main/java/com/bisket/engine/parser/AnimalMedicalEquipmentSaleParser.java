...
@Slf4j
public class AnimalMedicalEquipmentSaleParser {

    public static List<AnimalMedicalEquipmentSale> getListFromXml(Document xml) {
        List<AnimalMedicalEquipmentSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            AnimalMedicalEquipmentSale object = new AnimalMedicalEquipmentSale();
