...
import com.bisket.engine.entity.MartialArtAcademy;
...
@Slf4j
public class MartialArtAcademyParser {

    public static List<MartialArtAcademy> getListFromXml(Document xml) {
        List<MartialArtAcademy> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MartialArtAcademy object = new MartialArtAcademy();
