...
@Slf4j
public class FoodRefrigerationParser {

    public static List<FoodRefrigeration> getListFromXml(Document xml) {
        List<FoodRefrigeration> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FoodRefrigeration object = new FoodRefrigeration();
