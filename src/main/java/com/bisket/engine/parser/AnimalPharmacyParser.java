...
@Slf4j
public class AnimalPharmacyParser {

    public static List<AnimalPharmacy> getListFromXml(Document xml) {
        List<AnimalPharmacy> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            AnimalPharmacy object = new AnimalPharmacy();
