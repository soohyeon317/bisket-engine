...
import com.bisket.engine.entity.SewageTreatmentFacilityDesignConstruction;
...
@Slf4j
public class SewageTreatmentFacilityDesignConstructionParser {

    public static List<SewageTreatmentFacilityDesignConstruction> getListFromXml(Document xml) {
        List<SewageTreatmentFacilityDesignConstruction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            SewageTreatmentFacilityDesignConstruction object = new SewageTreatmentFacilityDesignConstruction();
