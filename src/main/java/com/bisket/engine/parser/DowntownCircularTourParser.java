...
import com.bisket.engine.entity.DowntownCircularTour;
...
@Slf4j
public class DowntownCircularTourParser {

    public static List<DowntownCircularTour> getListFromXml(Document xml) {
        List<DowntownCircularTour> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            DowntownCircularTour object = new DowntownCircularTour();
