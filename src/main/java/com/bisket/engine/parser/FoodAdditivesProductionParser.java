...
@Slf4j
public class FoodAdditivesProductionParser {

    public static List<FoodAdditivesProduction> getListFromXml(Document xml) {
        List<FoodAdditivesProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            FoodAdditivesProduction object = new FoodAdditivesProduction();
