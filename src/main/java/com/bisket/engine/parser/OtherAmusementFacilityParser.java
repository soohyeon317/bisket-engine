...
@Slf4j
public class OtherAmusementFacilityParser {

    public static List<OtherAmusementFacility> getListFromXml(Document xml) {
        List<OtherAmusementFacility> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            OtherAmusementFacility object = new OtherAmusementFacility();
