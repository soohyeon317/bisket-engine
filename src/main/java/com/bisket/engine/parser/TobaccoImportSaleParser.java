...
import com.bisket.engine.entity.TobaccoImportSale;
...
@Slf4j
public class TobaccoImportSaleParser {

    public static List<TobaccoImportSale> getListFromXml(Document xml) {
        List<TobaccoImportSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            TobaccoImportSale object = new TobaccoImportSale();
            ...
            for (int j = 0; j < childList.getLength(); j++) {
                ...
                if(!childList.item(j).getNodeName().equals("#text")) {
                    ...
                    switch (j) {
                        ...
                        case 57:
                            // 취급제품명
                            object.setHandlingProductName(itemValue);
                            break;
                        case 59:
                            // 담배공급업체명
                            object.setTobaccoSupplierName(itemValue);
                            break;
                        default:
                            break;
                    }
