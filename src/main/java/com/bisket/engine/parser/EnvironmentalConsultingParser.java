...
import com.bisket.engine.domain.EnvironmentalConsulting;
...
@Slf4j
public class EnvironmentalConsultingParser {

    public static List<EnvironmentalConsulting> getListFromXml(Document xml) {
        List<EnvironmentalConsulting> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            EnvironmentalConsulting object = new EnvironmentalConsulting();
