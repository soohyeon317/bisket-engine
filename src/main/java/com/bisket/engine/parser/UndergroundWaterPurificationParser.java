...
@Slf4j
public class UndergroundWaterPurificationParser {

    public static List<UndergroundWaterPurification> getListFromXml(Document xml) {
        List<UndergroundWaterPurification> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            UndergroundWaterPurification object = new UndergroundWaterPurification();
