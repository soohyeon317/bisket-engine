...
@Slf4j
public class VideoProductionParser {

    public static List<VideoProduction> getListFromXml(Document xml) {
        List<VideoProduction> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            VideoProduction object = new VideoProduction();
