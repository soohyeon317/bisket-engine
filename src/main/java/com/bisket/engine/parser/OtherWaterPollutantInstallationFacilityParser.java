...
@Slf4j
public class OtherWaterPollutantInstallationFacilityParser {

    public static List<OtherWaterPollutantInstallationFacility> getListFromXml(Document xml) {
        List<OtherWaterPollutantInstallationFacility> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            OtherWaterPollutantInstallationFacility object = new OtherWaterPollutantInstallationFacility();
