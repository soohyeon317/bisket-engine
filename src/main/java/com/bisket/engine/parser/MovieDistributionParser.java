...
@Slf4j
public class MovieDistributionParser {

    public static List<MovieDistribution> getListFromXml(Document xml) {
        List<MovieDistribution> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MovieDistribution object = new MovieDistribution();
