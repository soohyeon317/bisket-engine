...
@Slf4j
public class MedicalDeviceSaleLeaseParser {

    public static List<MedicalDeviceSaleLease> getListFromXml(Document xml) {
        List<MedicalDeviceSaleLease> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MedicalDeviceSaleLease object = new MedicalDeviceSaleLease();
