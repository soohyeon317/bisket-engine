...
@Slf4j
public class HaircuttingParser {

    public static List<Haircutting> getListFromXml(Document xml) {
        List<Haircutting> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            Haircutting object = new Haircutting();
