...
@Slf4j
public class ColdCallingSaleParser {

    public static List<ColdCallingSale> getListFromXml(Document xml) {
        List<ColdCallingSale> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            ColdCallingSale object = new ColdCallingSale();
