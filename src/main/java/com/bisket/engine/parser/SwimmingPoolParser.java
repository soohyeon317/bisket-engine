...
@Slf4j
public class SwimmingPoolParser {

    public static List<SwimmingPool> getListFromXml(Document xml) {
        List<SwimmingPool> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            SwimmingPool object = new SwimmingPool();
