...
import com.bisket.engine.entity.AnimalFuneral;
...
@Slf4j
public class AnimalFuneralParser {

    public static List<AnimalFuneral> getListFromXml(Document xml) {
        List<AnimalFuneral> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            AnimalFuneral object = new AnimalFuneral();
