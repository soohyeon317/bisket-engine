...
import com.bisket.engine.domain.CultureArtsCorporation;
...
@Slf4j
public class CultureArtsCorporationParser {

    public static List<CultureArtsCorporation> getListFromXml(Document xml) {
        List<CultureArtsCorporation> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            CultureArtsCorporation object = new CultureArtsCorporation();
