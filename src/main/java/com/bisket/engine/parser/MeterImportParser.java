...
@Slf4j
public class MeterImportParser {

    public static List<MeterImport> getListFromXml(Document xml) {
        List<MeterImport> objectList = new ArrayList<>();
        ...
        for (int i = 0; i < rowList.getLength(); i++) {
            ...
            MeterImport object = new MeterImport();
