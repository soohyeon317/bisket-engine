...
@Entity
@DiscriminatorValue("martial_art_gym")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MartialArtGym extends Business {
    ...
    public void getAndSetIdentification(MartialArtGym other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MartialArtGym other) {
        // 개방서비스명
