...
@Entity
@DiscriminatorValue("group_food_service_food_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GroupFoodServiceFoodSale extends Business {
    ...
    public void getAndSetIdentification(GroupFoodServiceFoodSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GroupFoodServiceFoodSale other) {
        // 개방서비스명
