...
@Entity
@DiscriminatorValue("movie_production_production")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MovieProduction extends Business {
    ...
    public void getAndSetIdentification(MovieProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }

    public void update(MovieProduction other) {
        // 개방서비스명
