...
@Entity
@DiscriminatorValue("food_additives_production")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FoodAdditivesProduction extends Business {
    ...
    public void getAndSetIdentification(FoodAdditivesProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FoodAdditivesProduction other) {
        // 개방서비스명
