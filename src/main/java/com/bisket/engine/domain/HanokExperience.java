...
@Entity
@DiscriminatorValue("hanok_experience")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class HanokExperience extends Business {
    ...
    public void getAndSetIdentification(HanokExperience other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(HanokExperience other) {
        // 개방서비스명
