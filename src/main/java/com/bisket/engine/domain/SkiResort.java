...
@Entity
@DiscriminatorValue("ski_resort")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class SkiResort extends Business {
    ...
    public void getAndSetIdentification(SkiResort other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(SkiResort other) {
        // 개방서비스명
