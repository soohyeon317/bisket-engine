...
@Entity
@DiscriminatorValue("general_restaurant")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GeneralRestaurant extends Business {
    ...
    public void getAndSetIdentification(GeneralRestaurant other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GeneralRestaurant other) {
        // 개방서비스명
