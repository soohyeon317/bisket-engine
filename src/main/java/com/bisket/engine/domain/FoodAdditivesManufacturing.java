...
@Entity
@DiscriminatorValue("food_additives_manufacturing")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FoodAdditivesManufacturing extends Business {
    ...
    public void getAndSetIdentification(FoodAdditivesManufacturing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FoodAdditivesManufacturing other) {
        // 개방서비스명
