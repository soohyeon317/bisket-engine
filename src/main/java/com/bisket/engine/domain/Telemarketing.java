...
@Entity
@DiscriminatorValue("telemarketing")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class Telemarketing extends Business {
    private String assetsScale;
    private String debtAmount;
    private String capital;
    private String saleMethodName;

    public void getAndSetIdentification(Telemarketing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(Telemarketing other) {
        // 개방서비스명
