...
@Entity
@DiscriminatorValue("general_camp")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GeneralCamp extends Business {
    ...
    public void getAndSetIdentification(GeneralCamp other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GeneralCamp other) {
        // 개방서비스명
