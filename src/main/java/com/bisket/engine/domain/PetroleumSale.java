...
@Entity
@DiscriminatorValue("petroleum_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class PetroleumSale extends Business {
    private String capital;
    @Column(columnDefinition = "TEXT")
    private String customer;

    public void getAndSetIdentification(PetroleumSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(PetroleumSale other) {
        // 개방서비스명
