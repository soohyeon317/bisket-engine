...
@Entity
@DiscriminatorValue("food_subdivision")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FoodSubdivision extends Business {
    ...
    public void getAndSetIdentification(FoodSubdivision other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FoodSubdivision other) {
        // 개방서비스명
