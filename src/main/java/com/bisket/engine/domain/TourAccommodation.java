...
@Entity
@DiscriminatorValue("tour_accommodation")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TourAccommodation extends Business {
    ...
    public void getAndSetIdentification(TourAccommodation other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TourAccommodation other) {
        // 개방서비스명
        ...
        // 관광숙박업상세명
        this.setTourAccommodationBusinessDetailedName(other.getTourAccommodationBusinessDetailedName());
    }
}
