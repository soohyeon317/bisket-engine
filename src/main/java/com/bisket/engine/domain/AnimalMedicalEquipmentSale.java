...
@Entity
@DiscriminatorValue("animal_medical_equipment_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AnimalMedicalEquipmentSale extends Business {
    ...
    public void getAndSetIdentification(AnimalMedicalEquipmentSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(AnimalMedicalEquipmentSale other) {
        // 개방서비스명
