...
@Entity
@DiscriminatorValue("composite_video_service")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CompositeVideoService extends Business {
    ...
    public void getAndSetIdentification(CompositeVideoService other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(CompositeVideoService other) {
        // 개방서비스명
