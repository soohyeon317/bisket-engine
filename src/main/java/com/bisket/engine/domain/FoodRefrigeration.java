...
@Entity
@DiscriminatorValue("food_refrigeration")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FoodRefrigeration extends Business {
    ...
    public void getAndSetIdentification(FoodRefrigeration other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FoodRefrigeration other) {
        // 개방서비스명
