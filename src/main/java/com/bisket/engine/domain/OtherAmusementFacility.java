...
@Entity
@DiscriminatorValue("other_amusement_facility")
...
public class OtherAmusementFacility extends Business {
    ...
    public void getAndSetIdentification(OtherAmusementFacility other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(OtherAmusementFacility other) {
        // 개방서비스명
