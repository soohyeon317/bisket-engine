...
@Entity
@DiscriminatorValue("meter_production")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MeterProduction extends Business {
    private String officePhoneNumber;
    private String businessPlacePhoneNumber;

    public void getAndSetIdentification(MeterProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MeterProduction other) {
        // 개방서비스명
