...
@Entity
@DiscriminatorValue("slaughter")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class Slaughter extends Business {
    ...
    public void getAndSetIdentification(Slaughter other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(Slaughter other) {
        // 개방서비스명
