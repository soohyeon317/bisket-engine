...
@Entity
@DiscriminatorValue("composite_distribution_game_service")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CompositeDistributionGameService extends Business {
    ...
    public void getAndSetIdentification(CompositeDistributionGameService other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(CompositeDistributionGameService other) {
        // 개방서비스명
