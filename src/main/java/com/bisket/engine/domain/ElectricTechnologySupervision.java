...
@Entity
@DiscriminatorValue("electric_technology_supervision")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ElectricTechnologySupervision extends Business {
    ...
    public void getAndSetIdentification(ElectricTechnologySupervision other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(ElectricTechnologySupervision other) {
        // 개방서비스명
        ...
        // 설계감리업종류명
        this.setDesignSupervisionBusinessKindName(other.getDesignSupervisionBusinessKindName());
        // 소속국가명
        this.setCountryName(other.getCountryName());
        // 실질자본금
        this.setRealCapital(other.getRealCapital());
    }
}
