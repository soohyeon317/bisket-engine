...
@NoArgsConstructor
@AllArgsConstructor
public class DowntownCircularTour extends Business {
    ...
    public void getAndSetIdentification(DowntownCircularTour other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(DowntownCircularTour other) {
        // 개방서비스명
