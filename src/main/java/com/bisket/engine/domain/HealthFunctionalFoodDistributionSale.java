...
@Entity
@DiscriminatorValue("health_functional_food_distribution_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class HealthFunctionalFoodDistributionSale extends Business {
    private String sanitaryBusinessCategoryName;
    ...
    public void getAndSetIdentification(HealthFunctionalFoodDistributionSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(HealthFunctionalFoodDistributionSale other) {
        // 개방서비스명
        ...
        // 위생업태명
        this.setSanitaryBusinessCategoryName(other.getSanitaryBusinessCategoryName());
        // 남성종사자수
