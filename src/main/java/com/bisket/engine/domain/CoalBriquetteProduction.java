...
@Entity
@DiscriminatorValue("coal_briquette_production")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CoalBriquetteProduction extends Business {
    ...
    public void getAndSetIdentification(CoalBriquetteProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(CoalBriquetteProduction other) {
        // 개방서비스명
