...
@Entity
@DiscriminatorValue("medical_device_repair")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MedicalDeviceRepair extends Business {
    ...
    public void getAndSetIdentification(MedicalDeviceRepair other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MedicalDeviceRepair other) {
        // 개방서비스ID
