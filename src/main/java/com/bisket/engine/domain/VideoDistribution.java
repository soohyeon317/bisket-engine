...
@Entity
@DiscriminatorValue("video_distribution")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class VideoDistribution extends Business {
    ...
    public void getAndSetIdentification(VideoDistribution other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(VideoDistribution other) {
        // 개방서비스명
