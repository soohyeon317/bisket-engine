...
@Entity
@DiscriminatorValue("instant_sale_production_processing")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class InstantSaleProductionProcessing extends Business {
    ...
    public void getAndSetIdentification(InstantSaleProductionProcessing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(InstantSaleProductionProcessing other) {
        // 개방서비스명
