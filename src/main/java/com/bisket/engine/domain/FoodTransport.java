...
@Entity
@DiscriminatorValue("food_transport")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FoodTransport extends Business {
    ...
    public void getAndSetIdentification(FoodTransport other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FoodTransport other) {
        // 개방서비스명
