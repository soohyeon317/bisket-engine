...
@Entity
@DiscriminatorValue("distribution_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class DistributionSale extends Business {
    ...
    public void getAndSetIdentification(DistributionSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(DistributionSale other) {
        // 개방서비스명
