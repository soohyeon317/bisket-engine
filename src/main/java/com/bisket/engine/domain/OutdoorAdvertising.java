...
@Entity
@DiscriminatorValue("outdoor_advertising")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OutdoorAdvertising extends Business {
    @Column(columnDefinition = "TEXT")
    private String businessContent;

    public void getAndSetIdentification(OutdoorAdvertising other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(OutdoorAdvertising other) {
        // 개방서비스명
        ...
        // 영업내용
        this.setBusinessContent(other.getBusinessContent());
    }
}
