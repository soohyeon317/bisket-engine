...
@Entity
@DiscriminatorValue("online_music_service")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OnlineMusicService extends Business {
    ...
    public void getAndSetIdentification(OnlineMusicService other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(OnlineMusicService other) {
        // 개방서비스명
