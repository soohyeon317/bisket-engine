...
@Entity
@DiscriminatorValue("music_record_distribution")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MusicRecordDistribution extends Business {
    ...
    public void getAndSetIdentification(MusicRecordDistribution other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MusicRecordDistribution other) {
        // 개방서비스명
