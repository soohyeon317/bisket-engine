...
@Entity
@DiscriminatorValue("physical_education_gym")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class PhysicalEducationGym extends Business {
    ...
    public void getAndSetIdentification(PhysicalEducationGym other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(PhysicalEducationGym other) {
        // 개방서비스명
