...
@Entity
@DiscriminatorValue("rest_restaurant")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class RestRestaurant extends Business {
    ...
    public void getAndSetIdentification(RestRestaurant other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(RestRestaurant other) {
        // 개방서비스명
