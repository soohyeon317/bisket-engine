...
@Entity
@DiscriminatorValue("milk_collection")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MilkCollection extends Business {
    ...
    public void getAndSetIdentification(MilkCollection other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MilkCollection other) {
        // 개방서비스명
