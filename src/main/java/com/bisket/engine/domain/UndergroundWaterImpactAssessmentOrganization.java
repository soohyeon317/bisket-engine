...
@NoArgsConstructor
@AllArgsConstructor
public class UndergroundWaterImpactAssessmentOrganization extends Business {
    ...
    public void getAndSetIdentification(UndergroundWaterImpactAssessmentOrganization other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(UndergroundWaterImpactAssessmentOrganization other) {
        // 개방서비스명
