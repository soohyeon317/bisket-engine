...
@Entity
@DiscriminatorValue("timber_import_distribution")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TimberImportDistribution extends Business {
    ...
    public void getAndSetIdentification(TimberImportDistribution other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TimberImportDistribution other) {
        // 개방서비스명
        ...
        // 목재생산업구분코드명
        this.setTimberProductionBusinessClassificationCode(other.getTimberProductionBusinessClassificationCode());
        // 목재생산업종류명
        this.setTimberProductionBusinessKindName(other.getTimberProductionBusinessKindName());
        // 취급목재제품
        this.setHandlingTimberProduct(other.getHandlingTimberProduct());
        // 인력보유현황
        this.setManpowerPossessionStatus(other.getManpowerPossessionStatus());
        // 년간생산량
        this.setAnnualProduction(other.getAnnualProduction());
        // 자본금
        this.setCapital(other.getCapital());
        // 상태구분명
        this.setStatusClassificationName(other.getStatusClassificationName());
    }
}
