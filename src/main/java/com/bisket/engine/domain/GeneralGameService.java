...
@Entity
@DiscriminatorValue("general_game_service")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GeneralGameService extends Business {
    ...
    public void getAndSetIdentification(GeneralGameService other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GeneralGameService other) {
        // 개방서비스명
