...
@NoArgsConstructor
@AllArgsConstructor
public class Glasses extends Business {
    ...
    public void getAndSetIdentification(Glasses other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(Glasses other) {
        // 개방서비스ID
        ...
        // 시력표수
        this.setEyesightChartCount(other.getEyesightChartCount());
        // 표본렌즈수
        this.setSampleLensCount(other.getSampleLensCount());
        // 측정의자수
        this.setMeasurementChairCount(other.getMeasurementChairCount());
        // 동공거리측정기수
        this.setPupillostatometerCount(other.getPupillostatometerCount());
        // 정점굴절계기수
        this.setVertexRefractometerCount(other.getVertexRefractometerCount());
        // 조제용연마기수
        this.setPreparativeGrinderCount(other.getPreparativeGrinderCount());
        // 렌즈절단기수
        this.setLensCutterCount(other.getLensCutterCount());
        // 가열기수
        this.setHeaterCount(other.getHeaterCount());
        // 안경세척기수
        this.setGlassesWasherCount(other.getGlassesWasherCount());
        // 총면적
