...
@Entity
@DiscriminatorValue("general_travel")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GeneralTravel extends Business {
    ...
    public void getAndSetIdentification(GeneralTravel other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GeneralTravel other) {
        // 개방서비스명
