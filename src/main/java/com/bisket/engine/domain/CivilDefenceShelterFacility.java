...
@Entity
@DiscriminatorValue("civil_defence_shelter_facility")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CivilDefenceShelterFacility extends Business {
    ...
    public void getAndSetIdentification(CivilDefenceShelterFacility other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(CivilDefenceShelterFacility other) {
        // 개방서비스명
