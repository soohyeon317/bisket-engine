...
@Entity
@DiscriminatorValue("amusement_bar")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AmusementBar extends Business {
    ...
    public void getAndSetIdentification(AmusementBar other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(AmusementBar other) {
        // 개방서비스명
