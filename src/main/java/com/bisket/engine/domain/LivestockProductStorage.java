...
@Entity
@DiscriminatorValue("livestock_product_storage")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class LivestockProductStorage extends Business {
    ...
    public void getAndSetIdentification(LivestockProductStorage other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(LivestockProductStorage other) {
        // 개방서비스ID
