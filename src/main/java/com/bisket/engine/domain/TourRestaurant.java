...
@Entity
@DiscriminatorValue("tour_restaurant")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TourRestaurant extends Business {
    ...
    public void getAndSetIdentification(TourRestaurant other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TourRestaurant other) {
        // 개방서비스명
