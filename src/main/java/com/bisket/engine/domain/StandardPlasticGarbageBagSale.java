...
@Entity
@DiscriminatorValue("standard_plastic_garbage_bag_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class StandardPlasticGarbageBagSale extends Business {
    ...
    public void getAndSetIdentification(StandardPlasticGarbageBagSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(StandardPlasticGarbageBagSale other) {
        // 개방서비스명
        ...
        // 신청일자
        this.setApplicationDate(other.getApplicationDate());
        // 항목값1
        this.setItemValue1(other.getItemValue1());
    }
}
