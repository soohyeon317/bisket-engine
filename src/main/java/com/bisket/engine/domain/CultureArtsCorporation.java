...
@Entity
@DiscriminatorValue("culture_arts_corporation")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CultureArtsCorporation extends Business {
    ...
    public void getAndSetIdentification(CultureArtsCorporation other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(CultureArtsCorporation other) {
        // 개방서비스명
