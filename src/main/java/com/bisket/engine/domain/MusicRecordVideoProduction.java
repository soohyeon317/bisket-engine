...
@Entity
@DiscriminatorValue("music_record_video_production")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MusicRecordVideoProduction extends Business {
    ...
    public void getAndSetIdentification(MusicRecordVideoProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MusicRecordVideoProduction other) {
        // 개방서비스명
