...
@Entity
@DiscriminatorValue("fee_charging_employment_agency")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FeeChargingEmploymentAgency extends Business {
    private String corporationClassificationName;
    private String classificationName;

    public void getAndSetIdentification(FeeChargingEmploymentAgency other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FeeChargingEmploymentAgency other) {
        // 개방서비스명
        ...
        // 법인구분명
        this.setCorporationClassificationName(other.getCorporationClassificationName());
        // 구분명
