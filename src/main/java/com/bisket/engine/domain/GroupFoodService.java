...
@Entity
@DiscriminatorValue("group_food_service")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GroupFoodService extends Business {
    ...
    public void getAndSetIdentification(GroupFoodService other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GroupFoodService other) {
        // 개방서비스명
