...
@Entity
@DiscriminatorValue("movie_screening")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MovieScreening extends Business {
    ...
    public void getAndSetIdentification(MovieScreening other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }

    public void update(MovieScreening other) {
        // 개방서비스명
