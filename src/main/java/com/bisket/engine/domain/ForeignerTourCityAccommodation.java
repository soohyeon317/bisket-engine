...
@Entity
@DiscriminatorValue("foreigner_tour_city_accommodation")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ForeignerTourCityAccommodation extends Business {
    ...
    public void getAndSetIdentification(ForeignerTourCityAccommodation other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(ForeignerTourCityAccommodation other) {
        // 개방서비스명
