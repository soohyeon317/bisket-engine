...
@Entity
@DiscriminatorValue("water_supply_construction_agency")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class WaterSupplyConstructionAgency extends Business {
    private String employeeCount;
    private String approvalStartDate;
    private String approvalEndDate;

    public void getAndSetIdentification(WaterSupplyConstructionAgency other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(WaterSupplyConstructionAgency other) {
        // 개방서비스명
        ...
        // 허가기간_시작일자
        this.setApprovalStartDate(other.getApprovalStartDate());
        // 허가기간_종료일자
        this.setApprovalEndDate(other.getApprovalEndDate());
    }
}
