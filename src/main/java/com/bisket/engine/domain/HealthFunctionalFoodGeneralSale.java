...
@Entity
@DiscriminatorValue("health_functional_food_general_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class HealthFunctionalFoodGeneralSale extends Business {
    ...
    public void getAndSetIdentification(HealthFunctionalFoodGeneralSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(HealthFunctionalFoodGeneralSale other) {
        // 개방서비스명
