...
@Entity
@DiscriminatorValue("video_watching_service")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class VideoWatchingService extends Business {
    ...
    public void getAndSetIdentification(VideoWatchingService other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }

    public void update(VideoWatchingService other) {
        // 개방서비스명
