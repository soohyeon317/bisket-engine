...
@Entity
@DiscriminatorValue("lumbering")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class Lumbering extends Business {
    ...
    public void getAndSetIdentification(Lumbering other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(Lumbering other) {
        // 개방서비스명
