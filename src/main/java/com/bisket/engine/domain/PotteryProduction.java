...
@Entity
@DiscriminatorValue("pottery_production")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class PotteryProduction extends Business {
    ...
    public void getAndSetIdentification(PotteryProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(PotteryProduction other) {
        // 개방서비스명
