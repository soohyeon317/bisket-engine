...
@Entity
@DiscriminatorValue("sewage_treatment_facility_design_construction")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class SewageTreatmentFacilityDesignConstruction extends Business {
    ...
    public void getAndSetIdentification(SewageTreatmentFacilityDesignConstruction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(SewageTreatmentFacilityDesignConstruction other) {
        // 개방서비스명
