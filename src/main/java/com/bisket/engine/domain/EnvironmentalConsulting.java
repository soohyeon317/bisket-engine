...
@Entity
@DiscriminatorValue("environmental_consulting")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class EnvironmentalConsulting extends Business {
    ...
    public void getAndSetIdentification(EnvironmentalConsulting other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(EnvironmentalConsulting other) {
        // 개방서비스명
