...
@Entity
@DiscriminatorValue("international_conference_planning")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class InternationalConferencePlanning extends Business {
    ...
    public void getAndSetIdentification(InternationalConferencePlanning other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(InternationalConferencePlanning other) {
        // 개방서비스명
