...
@NoArgsConstructor
@AllArgsConstructor
public class FuneralDirectorEducationOrganization extends Business {
    ...
    public void getAndSetIdentification(FuneralDirectorEducationOrganization other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FuneralDirectorEducationOrganization other) {
        // 개방서비스명
