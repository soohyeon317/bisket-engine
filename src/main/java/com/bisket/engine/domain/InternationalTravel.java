...
@Entity
@DiscriminatorValue("international_travel")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class InternationalTravel extends Business {
    ...
    public void getAndSetIdentification(InternationalTravel other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(InternationalTravel other) {
        // 개방서비스명
