...
@Entity
@DiscriminatorValue("food_production_processing")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FoodProductionProcessing extends Business {
    ...
    public void getAndSetIdentification(FoodProductionProcessing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FoodProductionProcessing other) {
        // 개방서비스명
