...
@Entity
@DiscriminatorValue("animal_medicine_wholesale_store")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AnimalMedicineWholesaleStore extends Business {
    ...
    public void getAndSetIdentification(AnimalMedicineWholesaleStore other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(AnimalMedicineWholesaleStore other) {
        // 개방서비스명
