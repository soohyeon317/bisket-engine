...
@Entity
@DiscriminatorValue("consignment_food_service")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ConsignmentFoodService extends Business {
    ...
    public void getAndSetIdentification(ConsignmentFoodService other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(ConsignmentFoodService other) {
        // 개방서비스명
