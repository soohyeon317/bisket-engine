...
@Entity
@DiscriminatorValue("other_food_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OtherFoodSale extends Business {
    ...
    public void getAndSetIdentification(OtherFoodSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(OtherFoodSale other) {
        // 개방서비스명
