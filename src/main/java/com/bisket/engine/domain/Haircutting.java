...
@Entity
@DiscriminatorValue("haircutting")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class Haircutting extends Business {
    ...
    public void getAndSetIdentification(Haircutting other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(Haircutting other) {
        // 개방서비스명
