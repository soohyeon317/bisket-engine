...
@Entity
@DiscriminatorValue("music_record_video_distribution")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MusicRecordVideoDistribution extends Business {
    ...
    public void getAndSetIdentification(MusicRecordVideoDistribution other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MusicRecordVideoDistribution other) {
        // 개방서비스명
