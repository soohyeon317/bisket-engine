...
@NoArgsConstructor
@AllArgsConstructor
public class ContainerFreezerSpecificFacility extends Business {
    @Column(columnDefinition = "TEXT")
    private String facilityStandard;

    public void getAndSetIdentification(ContainerFreezerSpecificFacility other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(ContainerFreezerSpecificFacility other) {
        // 개방서비스명
        ...
        // 설비규격
        this.setFacilityStandard(other.getFacilityStandard());
    }
}
