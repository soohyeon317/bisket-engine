...
@Entity
@DiscriminatorValue("feed_production")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FeedProduction extends Business {
    ...
    public void getAndSetIdentification(FeedProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FeedProduction other) {
        // 개방서비스ID
