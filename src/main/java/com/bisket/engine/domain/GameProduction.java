...
@Entity
@DiscriminatorValue("game_production")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GameProduction extends Business {
    ...
    public void getAndSetIdentification(GameProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GameProduction other) {
        // 개방서비스명
