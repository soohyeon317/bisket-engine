...
@Entity
@DiscriminatorValue("internet_computer_game_facility_service")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class InternetComputerGameFacilityService extends Business {
    ...
    public void getAndSetIdentification(InternetComputerGameFacilityService other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(InternetComputerGameFacilityService other) {
        // 개방서비스명
