...
@Entity
@DiscriminatorValue("tour_theater_amusement")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TourTheaterAmusement extends Business {
    ...
    public void getAndSetIdentification(TourTheaterAmusement other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TourTheaterAmusement other) {
        // 개방서비스명
