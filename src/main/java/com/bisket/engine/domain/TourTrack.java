...
@Entity
@DiscriminatorValue("tour_track")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TourTrack extends Business {
    ...
    public void getAndSetIdentification(TourTrack other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TourTrack other) {
        // 개방서비스명
