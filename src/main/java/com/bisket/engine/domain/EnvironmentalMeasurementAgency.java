...
@Entity
@DiscriminatorValue("environmental_measurement_agency")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class EnvironmentalMeasurementAgency extends Business {
    ...
    public void getAndSetIdentification(EnvironmentalMeasurementAgency other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(EnvironmentalMeasurementAgency other) {
        // 개방서비스명
