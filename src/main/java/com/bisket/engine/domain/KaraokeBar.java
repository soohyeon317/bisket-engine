...
@Entity
@DiscriminatorValue("karaoke_bar")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class KaraokeBar extends Business {
    ...
    public void getAndSetIdentification(KaraokeBar other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(KaraokeBar other) {
        // 개방서비스명
