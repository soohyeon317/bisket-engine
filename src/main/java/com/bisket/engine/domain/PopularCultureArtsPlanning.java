...
@Entity
@DiscriminatorValue("popular_culture_arts_planning")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class PopularCultureArtsPlanning extends Business {
    ...
    public void getAndSetIdentification(PopularCultureArtsPlanning other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(PopularCultureArtsPlanning other) {
        // 개방서비스명
