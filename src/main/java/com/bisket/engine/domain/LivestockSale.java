...
@Entity
@DiscriminatorValue("livestock_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class LivestockSale extends Business {
    ...
    public void getAndSetIdentification(LivestockSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(LivestockSale other) {
        // 개방서비스명
