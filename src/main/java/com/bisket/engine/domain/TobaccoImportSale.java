...
@Entity
@DiscriminatorValue("tobacco_import_sale")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TobaccoImportSale extends Business {
    @Column(columnDefinition = "TEXT")
    private String handlingProductName;
    @Column(columnDefinition = "TEXT")
    private String tobaccoSupplierName;

    public void getAndSetIdentification(TobaccoImportSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TobaccoImportSale other) {
        // 개방서비스명
        ...
        // 취급제품명
        this.setHandlingProductName(other.getHandlingProductName());
        // 담배공급업체명
        this.setTobaccoSupplierName(other.getTobaccoSupplierName());
    }
}
