...
@Entity
@DiscriminatorValue("TOBACCO_WHOLESALE")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TobaccoWholesale extends Business {
    @Column(columnDefinition = "TEXT")
    private String handlingProductName;
    @Column(columnDefinition = "TEXT")
    private String tobaccoSupplierName;

    public void getAndSetIdentification(TobaccoWholesale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TobaccoWholesale other) {
        // 개방서비스명
