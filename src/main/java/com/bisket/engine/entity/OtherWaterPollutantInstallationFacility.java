...
@Entity
@DiscriminatorValue("OTHER_WATER_POLLUTANT_INSTALLATION_FACILITY")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OtherWaterPollutantInstallationFacility extends Business {
    ...
    public void getAndSetIdentification(OtherWaterPollutantInstallationFacility other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(OtherWaterPollutantInstallationFacility other) {
        // 개방서비스명
