...
@Entity
@DiscriminatorValue("overall_sports_facility")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
public class OverallSportsFacility extends Business {

    public void getAndSetIdentification(OverallSportsFacility other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(OverallSportsFacility other) {
        // 개방서비스명
