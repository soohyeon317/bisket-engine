...
@Entity
@DiscriminatorValue("TOUR_PENSION")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TourPension extends Business {
    ...
    public void getAndSetIdentification(TourPension other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TourPension other) {
        // 개방서비스명
