...
@Entity
@DiscriminatorValue("FOREIGNER_AMUSEMENT_RESTAURANT")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ForeignerAmusementRestaurant extends Business {
    ...
    public void getAndSetIdentification(ForeignerAmusementRestaurant other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(ForeignerAmusementRestaurant other) {
        // 개방서비스명
