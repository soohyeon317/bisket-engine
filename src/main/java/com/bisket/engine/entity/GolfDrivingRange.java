...
@Entity
@DiscriminatorValue("golf_driving_range")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GolfDrivingRange extends Business {
    ...
    public void getAndSetIdentification(GolfDrivingRange other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GolfDrivingRange other) {
        // 개방서비스명
