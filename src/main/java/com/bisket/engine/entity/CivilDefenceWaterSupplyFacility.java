...
@Entity
@DiscriminatorValue("CIVIL_DEFENCE_WATER_SUPPLY_FACILITY")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CivilDefenceWaterSupplyFacility extends Business {
    ...
    public void getAndSetIdentification(CivilDefenceWaterSupplyFacility other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(CivilDefenceWaterSupplyFacility other) {
        // 개방서비스명
        ...
        // 비상시설위치
        this.setEmergencyFacilityLocation(other.getEmergencyFacilityLocation());
        // 시설구분명
        this.setFacilityClassificationName(other.getFacilityClassificationName());
        // 시설명_건물명
        this.setFacilityNameBuildingName(other.getFacilityNameBuildingName());
        // 해제일자
