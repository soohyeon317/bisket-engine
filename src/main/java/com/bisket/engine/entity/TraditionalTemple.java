...
@Entity
@DiscriminatorValue("TRADITIONAL_TEMPLE")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TraditionalTemple extends Business {
    ...
    public void getAndSetIdentification(TraditionalTemple other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TraditionalTemple other) {
        // 개방서비스명
        ...
        // 승려수
        this.setBuddhistMonkCount(other.getBuddhistMonkCount());
        // 신도수
        this.setBelieverCount(other.getBelieverCount());
        // 창립연대
        this.setEstablishmentEra(other.getEstablishmentEra());
        // 유래연혁
        this.setOriginHistory(other.getOriginHistory());
        // 지정취소
        this.setAppointmentCancel(other.getAppointmentCancel());
        // 지정취소일자
        this.setAppointmentCancelDate(other.getAppointmentCancelDate());
        // 지정취소사유
        this.setAppointmentCancelReason(other.getAppointmentCancelReason());
        // 전통사찰명
        this.setTraditionalTempleName(other.getTraditionalTempleName());
    }
}
