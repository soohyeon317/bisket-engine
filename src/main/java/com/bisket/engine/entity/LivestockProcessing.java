...
@Entity
@DiscriminatorValue("LIVESTOCK_PROCESSING")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class LivestockProcessing extends Business {
    ...
    public void getAndSetIdentification(LivestockProcessing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(LivestockProcessing other) {
        // 개방서비스명
