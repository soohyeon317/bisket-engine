...
@Entity
@DiscriminatorValue("ANIMAL_SALE")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AnimalSale extends Business {
    ...
    public void getAndSetIdentification(AnimalSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(AnimalSale other) {
        // 개방서비스명
