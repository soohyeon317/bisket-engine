...
@Entity
@DiscriminatorValue("teenager_game_service")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TeenagerGameService extends Business {
    ...
    public void getAndSetIdentification(TeenagerGameService other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TeenagerGameService other) {
        // 개방서비스명
