...
@Entity
@DiscriminatorValue("YACHTING_COURSE")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class YachtingCourse extends Business {
    ...
    public void getAndSetIdentification(YachtingCourse other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(YachtingCourse other) {
        // 개방서비스명
