...
@Entity
@DiscriminatorValue("air_pollutant_discharge_facility_installation")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AirPollutantDischargeFacilityInstallation extends Business {
    ...
    public void getAndSetIdentification(AirPollutantDischargeFacilityInstallation other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(AirPollutantDischargeFacilityInstallation other) {
        // 개방서비스명
