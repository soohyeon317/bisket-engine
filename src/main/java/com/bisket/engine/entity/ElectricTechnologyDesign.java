...
@Entity
@DiscriminatorValue("ELECTRIC_TECHNOLOGY_DESIGN")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ElectricTechnologyDesign extends Business {
    ...
    public void getAndSetIdentification(ElectricTechnologyDesign other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(ElectricTechnologyDesign other) {
        // 개방서비스명
