...
@Entity
@DiscriminatorValue("LIVESTOCK_PRODUCT_TRANSPORT")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class LivestockProductTransport extends Business {
    ...
    public void getAndSetIdentification(LivestockProductTransport other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(LivestockProductTransport other) {
        // 개방서비스명
