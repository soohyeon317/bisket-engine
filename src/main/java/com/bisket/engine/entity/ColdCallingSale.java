...
@Entity
@DiscriminatorValue("COLD_CALLING_SALE")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ColdCallingSale extends Business {
    private String assetsScale;
    private String debtAmount;
    private String capital;
    private String saleMethodName;

    public void getAndSetIdentification(ColdCallingSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(ColdCallingSale other) {
        // 개방서비스명
        ...
        // 자산규모
        this.setAssetsScale(other.getAssetsScale());
        // 부채총액
        this.setDebtAmount(other.getDebtAmount());
        // 자본금
        this.setCapital(other.getCapital());
        // 판매방식명
        this.setSaleMethodName(other.getSaleMethodName());
    }
}
