...
@Entity
@DiscriminatorValue("ANIMAL_HOSPITAL")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AnimalHospital extends Business {
    ...
    public void getAndSetIdentification(AnimalHospital other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(AnimalHospital other) {
        // 개방서비스명
