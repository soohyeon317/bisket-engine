...
@Entity
@DiscriminatorValue("SPECIALIZED_RECREATION")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class SpecializedRecreation extends Business {
    ...
    public void getAndSetIdentification(SpecializedRecreation other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(SpecializedRecreation other) {
        // 개방서비스명
