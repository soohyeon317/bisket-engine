...
@Entity
@DiscriminatorValue("SPECIFIC_PRESSURE_GAS")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class SpecificPressureGas extends Business {
    ...
    public void getAndSetIdentification(SpecificPressureGas other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(SpecificPressureGas other) {
        // 개방서비스명
        ...
        // 사용목적
        this.setUsePurpose(other.getUsePurpose());
        // 사용방법
        this.setUseMethod(other.getUseMethod());
        // 월사용량
        this.setMonthlyUsage(other.getMonthlyUsage());
        // 수용정원수
        this.setCapacity(other.getCapacity());
        // 시설사용여부
        this.setFacilityUseFlag(other.getFacilityUseFlag());
    }
}
