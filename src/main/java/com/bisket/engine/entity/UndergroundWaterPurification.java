...
@Entity
@DiscriminatorValue("UNDERGROUND_WATER_PURIFICATION")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class UndergroundWaterPurification extends Business {
    ...
    public void getAndSetIdentification(UndergroundWaterPurification other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(UndergroundWaterPurification other) {
        // 개방서비스명
        ...
        // 전문인력총수
        this.setSpecialistCount(other.getSpecialistCount());
        // 자본금
        this.setCapital(other.getCapital());
        // 시설장비
        this.setFacilityEquipment(other.getFacilityEquipment());
        // 타기관이전여부
        this.setOtherOrganizationTransferFlag(other.getOtherOrganizationTransferFlag());
    }
}
