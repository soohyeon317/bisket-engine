...
@Entity
@DiscriminatorValue("video_little_theater")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class VideoLittleTheater extends Business {
    ...
    public void getAndSetIdentification(VideoLittleTheater other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }

    public void update(VideoLittleTheater other) {
        // 개방서비스명
