...
@Entity
@DiscriminatorValue("music_record_production")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MusicRecordProduction extends Business {
    ...
    public void getAndSetIdentification(MusicRecordProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MusicRecordProduction other) {
        // 개방서비스명
