...
@Entity
@DiscriminatorValue("PUBLISHING")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class Publishing extends Business {
    ...
    public void getAndSetIdentification(Publishing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }

    public void update(Publishing other) {
        // 개방서비스명
