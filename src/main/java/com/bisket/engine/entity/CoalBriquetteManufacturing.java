...
@Entity
@DiscriminatorValue("COAL_BRIQUETTE_MANUFACTURING")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class CoalBriquetteManufacturing extends Business {
    ...
    public void getAndSetIdentification(CoalBriquetteManufacturing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(CoalBriquetteManufacturing other) {
        // 개방서비스명
        ...
        // 저탄장면적
        this.setCoalYardArea(other.getCoalYardArea());
        // 철도인입선유무명
        this.setRailwayIndustrialLineFlag(other.getRailwayIndustrialLineFlag());
        // 사업개시예정일자
        this.setBusinessOpenScheduleDate(other.getBusinessOpenScheduleDate());
        // 윤전기생산시설
        this.setRotaryPressProductionFacility(other.getRotaryPressProductionFacility());
    }
}
