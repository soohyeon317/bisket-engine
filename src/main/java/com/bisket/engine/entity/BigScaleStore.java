...
@Entity
@DiscriminatorValue("big_scale_store")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class BigScaleStore extends Business {
    private String storeClassificationName;

    public void getAndSetIdentification(BigScaleStore other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(BigScaleStore other) {
        // 개방서비스명
        ...
        // 점포구분명
        this.setStoreClassificationName(other.getStoreClassificationName());
    }
}
