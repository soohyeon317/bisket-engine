...
@Entity
@DiscriminatorValue("ANIMAL_PHARMACY")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AnimalPharmacy extends Business {
    ...
    public void getAndSetIdentification(AnimalPharmacy other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(AnimalPharmacy other) {
        // 개방서비스명
