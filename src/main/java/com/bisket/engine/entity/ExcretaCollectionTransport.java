...
@NoArgsConstructor
@AllArgsConstructor
public class ExcretaCollectionTransport extends Business {
    ...
    public void getAndSetIdentification(ExcretaCollectionTransport other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(ExcretaCollectionTransport other) {
        // 개방서비스명
