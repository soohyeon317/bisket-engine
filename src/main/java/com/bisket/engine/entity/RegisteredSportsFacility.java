...
@Entity
@DiscriminatorValue("REGISTERED_SPORTS_FACILITY")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class RegisteredSportsFacility extends Business {
    ...
    public void getAndSetIdentification(RegisteredSportsFacility other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(RegisteredSportsFacility other) {
        // 개방서비스명
