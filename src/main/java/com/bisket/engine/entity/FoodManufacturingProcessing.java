...
@Entity
@DiscriminatorValue("FOOD_MANUFACTURING_PROCESSING")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class FoodManufacturingProcessing extends Business {
    ...
    public void getAndSetIdentification(FoodManufacturingProcessing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(FoodManufacturingProcessing other) {
        // 개방서비스명
