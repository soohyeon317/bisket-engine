...
@Entity
@DiscriminatorValue("MEAT_PACKAGING")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MeatPackaging extends Business {
    ...
    public void getAndSetIdentification(MeatPackaging other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MeatPackaging other) {
        // 개방서비스명
