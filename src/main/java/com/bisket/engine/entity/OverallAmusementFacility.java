...
@Entity
@DiscriminatorValue("overall_amusement_facility")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OverallAmusementFacility extends Business {
    ...
    public void getAndSetIdentification(OverallAmusementFacility other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(OverallAmusementFacility other) {
        // 개방서비스명
