...
@Entity
@DiscriminatorValue("bathhouse")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class Bathhouse extends Business {
    ...
    public void getAndSetIdentification(Bathhouse other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(Bathhouse other) {
        // 개방서비스명
