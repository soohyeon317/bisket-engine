...
@Entity
@DiscriminatorValue("tobacco_retail")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TobaccoRetail extends Business {
    private String appointmentDate;
    private String civilComplaintKindName;

    public void getAndSetIdentification(TobaccoRetail other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TobaccoRetail other) {
        // 개방서비스명
