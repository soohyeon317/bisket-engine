...
@Entity
@DiscriminatorValue("livestock_excreta_collection_transport")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class LivestockExcretaCollectionTransport extends Business {
    ...
    public void getAndSetIdentification(LivestockExcretaCollectionTransport other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(LivestockExcretaCollectionTransport other) {
        // 개방서비스명
