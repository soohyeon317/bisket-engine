...
@Entity
@DiscriminatorValue("ENVIRONMENTAL_MANAGEMENT_AGENCY")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class EnvironmentalManagementAgency extends Business {
    ...
    public void getAndSetIdentification(EnvironmentalManagementAgency other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(EnvironmentalManagementAgency other) {
        // 개방서비스명
