...
@Entity
@DiscriminatorValue("discharge_gas_maintenance_check_agency")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class DischargeGasMaintenanceCheckAgency extends Business {
    ...
    public void getAndSetIdentification(DischargeGasMaintenanceCheckAgency other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(DischargeGasMaintenanceCheckAgency other) {
        // 개방서비스명
