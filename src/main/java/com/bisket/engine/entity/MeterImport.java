...
@Entity
@DiscriminatorValue("meter_import")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MeterImport extends Business {
    private String officePhoneNumber;
    private String businessPlacePhoneNumber;

    public void getAndSetIdentification(MeterImport other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MeterImport other) {
        // 개방서비스명
