...
@Entity
@DiscriminatorValue("underground_water_construction")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class UndergroundWaterConstruction extends Business {
    ...
    public void getAndSetIdentification(UndergroundWaterConstruction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(UndergroundWaterConstruction other) {
        // 개방서비스명
