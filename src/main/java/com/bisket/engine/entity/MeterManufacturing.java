...
@Entity
@DiscriminatorValue("meter_manufacturing")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MeterManufacturing extends Business {
    private String officePhoneNumber;
    private String businessPlacePhoneNumber;

    public void getAndSetIdentification(MeterManufacturing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MeterManufacturing other) {
        // 개방서비스명
        ...
        // 사무소전화번호
        this.setOfficePhoneNumber(other.getOfficePhoneNumber());
        // 사업장전화번호
        this.setBusinessPlacePhoneNumber(other.getBusinessPlacePhoneNumber());
    }
}
