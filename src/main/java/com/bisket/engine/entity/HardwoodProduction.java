...
@NoArgsConstructor
@AllArgsConstructor
public class HardwoodProduction extends Business {
    ...
    public void getAndSetIdentification(HardwoodProduction other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(HardwoodProduction other) {
        // 개방서비스명
