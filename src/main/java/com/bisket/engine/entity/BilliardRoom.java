...
@Entity
@DiscriminatorValue("billiard_room")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class BilliardRoom extends Business {
    ...
    public void getAndSetIdentification(BilliardRoom other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(BilliardRoom other) {
        // 개방서비스명
