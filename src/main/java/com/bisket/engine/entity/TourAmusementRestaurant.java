...
@Entity
@DiscriminatorValue("TOUR_AMUSEMENT_RESTAURANT")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TourAmusementRestaurant extends Business {
    ...
    public void getAndSetIdentification(TourAmusementRestaurant other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TourAmusementRestaurant other) {
        // 개방서비스명
