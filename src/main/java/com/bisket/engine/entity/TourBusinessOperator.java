...
@Entity
@DiscriminatorValue("tour_business_operator")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TourBusinessOperator extends Business {
    ...
    public void getAndSetIdentification(TourBusinessOperator other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(TourBusinessOperator other) {
        // 개방서비스명
