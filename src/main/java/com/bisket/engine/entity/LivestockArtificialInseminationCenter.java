...
@Entity
@DiscriminatorValue("livestock_artificial_insemination_center")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class LivestockArtificialInseminationCenter extends Business {
    ...
    public void getAndSetIdentification(LivestockArtificialInseminationCenter other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(LivestockArtificialInseminationCenter other) {
        // 개방서비스명
