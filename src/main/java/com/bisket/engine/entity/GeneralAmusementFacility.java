...
@Entity
@DiscriminatorValue("GENERAL_AMUSEMENT_FACILITY")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GeneralAmusementFacility extends Business {
    ...
    public void getAndSetIdentification(GeneralAmusementFacility other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GeneralAmusementFacility other) {
        // 개방서비스명
