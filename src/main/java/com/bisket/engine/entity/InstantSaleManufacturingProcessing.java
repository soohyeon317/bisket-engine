...
@Entity
@DiscriminatorValue("instant_sale_manufacturing_processing")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class InstantSaleManufacturingProcessing extends Business {
    ...
    public void getAndSetIdentification(InstantSaleManufacturingProcessing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(InstantSaleManufacturingProcessing other) {
        // 개방서비스명
