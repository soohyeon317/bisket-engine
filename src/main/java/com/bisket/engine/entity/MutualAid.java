...
@Entity
@DiscriminatorValue("mutual_aid")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MutualAid extends Business {
    ...
    public void getAndSetIdentification(MutualAid other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MutualAid other) {
        // 개방서비스명
        ...
        // 민원종류명
        this.setCivilComplaintKindName(other.getCivilComplaintKindName());
        // 자본금의 규모
        this.setCapitalScale(other.getCapitalScale());
        // 예치기관명
        this.setDepositOrganizationName(other.getDepositOrganizationName());
        // 공제계약명
        this.setMutualAidContractName(other.getMutualAidContractName());
        // 공제계약기타명
        this.setOtherMutualAidContractName(other.getOtherMutualAidContractName());
        // 보험
        this.setInsurance(other.getInsurance());
        // 채무지급보증
        this.setDebtPaymentGuarantee(other.getDebtPaymentGuarantee());
    }
}
