...
@Entity
@DiscriminatorValue("GOLF_COURSE")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class GolfCourse extends Business {
    ...
    public void getAndSetIdentification(GolfCourse other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(GolfCourse other) {
        // 개방서비스명
