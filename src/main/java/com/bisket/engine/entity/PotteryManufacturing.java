...
@Entity
@DiscriminatorValue("POTTERY_MANUFACTURING")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class PotteryManufacturing extends Business {
    ...
    public void getAndSetIdentification(PotteryManufacturing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(PotteryManufacturing other) {
        // 개방서비스명
