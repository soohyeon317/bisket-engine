...
@Entity
@DiscriminatorValue("METER_REPAIR")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MeterRepair extends Business {
    private String officePhoneNumber;
    private String businessPlacePhoneNumber;

    public void getAndSetIdentification(MeterRepair other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(MeterRepair other) {
        // 개방서비스명
