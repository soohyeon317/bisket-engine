...
@Entity
@DiscriminatorValue("affiliated_medical_organization")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AffiliatedMedicalOrganization extends Business {
    ...
    public void getAndSetIdentification(AffiliatedMedicalOrganization other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }

    public void update(AffiliatedMedicalOrganization other) {
        // 개방서비스명
