...
@Entity
@DiscriminatorValue("CONTAINER_WRAPPER_MANUFACTURING")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ContainerWrapperManufacturing extends Business {
    ...
    public void getAndSetIdentification(ContainerWrapperManufacturing other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(ContainerWrapperManufacturing other) {
        // 개방서비스명
