...
@Entity
@DiscriminatorValue("VIDEO_ROOM")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class VideoRoom extends Business {
    ...
    public void getAndSetIdentification(VideoRoom other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }

    public void update(VideoRoom other) {
        // 개방서비스명
