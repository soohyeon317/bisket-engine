...
@Entity
@DiscriminatorValue("individual_sewage_treatment_facility_management")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class IndividualSewageTreatmentFacilityManagement extends Business {
    ...
    public void getAndSetIdentification(IndividualSewageTreatmentFacilityManagement other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(IndividualSewageTreatmentFacilityManagement other) {
        // 개방서비스명
