...
@Entity
@DiscriminatorValue("DOOR_TO_DOOR_SALE")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class DoorToDoorSale extends Business {
    private String assetsScale;
    private String debtAmount;
    private String capital;
    private String saleMethodName;

    public void getAndSetIdentification(DoorToDoorSale other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(DoorToDoorSale other) {
        // 개방서비스명
