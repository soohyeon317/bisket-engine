...
@Entity
@DiscriminatorValue("building_sanitation")
@EqualsAndHashCode(callSuper = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class BuildingSanitation extends Business {
    ...
    public void getAndSetIdentification(BuildingSanitation other) {
        this.setId(other.getId());
        this.setCreatedAt(other.getCreatedAt());
        this.setModifiedAt(other.getModifiedAt());
    }
    
    public void update(BuildingSanitation other) {
        // 개방서비스명
