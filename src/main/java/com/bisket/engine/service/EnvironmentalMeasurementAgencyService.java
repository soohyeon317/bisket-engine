...
import com.bisket.engine.parser.EnvironmentalMeasurementAgencyParser;
import com.bisket.engine.repository.EnvironmentalMeasurementAgencyRepository;
    ...
    public Integer updateListFromXmlFile(String filePath) throws Exception {
        ...
        if (!parsedList.isEmpty()) {
            ...
            for (int i = 0; i < parsedList.size(); i++) {
                EnvironmentalMeasurementAgency parsed = parsedList.get(i);
                ...
                if (compositeKeyToFoundObjectMap.containsKey(compositeKey)) {
                    ...
                    /* 인서트 진행 */
                    environmentalMeasurementAgencyRepository.save(parsed);
                }
            }
        }
