...
import com.bisket.engine.entity.LiquefiedPetroleumGasApplianceManufacturing;
...
public class LiquefiedPetroleumGasApplianceManufacturingService implements BusinessBaseService {
    ...
    public Integer updateListFromXmlFile(String filePath) throws Exception {
        ...
        if (!parsedList.isEmpty()) {
            Map<String, LiquefiedPetroleumGasApplianceManufacturing> compositeKeyToFoundObjectMap = new HashMap<>();
            ...
            for (int i = 0; i < parsedList.size(); i++) {
                ...
                if (compositeKeyToFoundObjectMap.containsKey(compositeKey)) {
                    /* 업데이트 진행 */
                    LiquefiedPetroleumGasApplianceManufacturing found = compositeKeyToFoundObjectMap.get(compositeKey);
